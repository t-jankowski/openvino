...
TEST(TransformationTests, ConvertToLeakyReluTest1) {
    std::shared_ptr<ov::Model> f(nullptr), f_ref(nullptr);
    {
        ...
        auto slope = ov::op::v0::Constant::create(ov::element::f32, ov::Shape{}, { -2.f });
        auto prelu = std::make_shared<ov::op::v0::PRelu>(input, slope);
...
TEST(TransformationTests, ConvertToLeakyReluTest3) {
    std::shared_ptr<ov::Model> f(nullptr), f_ref(nullptr);
    {
        auto input = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ov::PartialShape::dynamic());
        auto slope = ov::op::v0::Constant::create(ov::element::f32, ov::Shape{}, { -2.f });
        auto prelu = std::make_shared<ov::op::v0::PRelu>(input, slope);
...
TEST(TransformationTests, ConvertToLeakyReluTest4) {
    std::shared_ptr<ov::Model> f(nullptr), f_ref(nullptr);
    {
        ...
        auto slope = ov::op::v0::Constant::create(ov::element::f32, ov::Shape{}, { -2.f });
        auto relaxed_prelu = std::make_shared<ov::op::TypeRelaxed<ov::op::v0::PRelu>>(
...
TEST(TransformationTests, ConvertToLeakyReluTest5) {
    ...
    {
        auto input = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ov::Shape{ 1, 3, 16, 16 });
        auto slope = ov::op::v0::Constant::create(ov::element::f32, ov::Shape{ 3 }, { -2.f, -1.f, -2.f });
        auto prelu = std::make_shared<ov::op::v0::PRelu>(input, slope);
