...
std::shared_ptr<ov::Model> MHAFunction::initOriginal() const {
    auto transpose0Param = std::make_shared<ov::op::v0::Parameter>(precisions[0], input_shapes[0]);
    auto transpose1Param = std::make_shared<ov::op::v0::Parameter>(precisions[1], input_shapes[1]);
    auto addParam = std::make_shared<ov::op::v0::Parameter>(precisions[2], input_shapes[2]);
    auto transpose2Param = std::make_shared<ov::op::v0::Parameter>(precisions[3], input_shapes[3]);
    ...
    if (with_reshape) {
        ...
        const auto softMax = std::make_shared<ov::op::v1::Softmax>(add, rank - 1);
...
std::shared_ptr<ov::Model> MHAFunction::initReference() const {
    auto data0 = std::make_shared<ov::op::v0::Parameter>(precisions[0], input_shapes[0]);
    auto data1 = std::make_shared<ov::op::v0::Parameter>(precisions[1], input_shapes[1]);
    auto data2 = std::make_shared<ov::op::v0::Parameter>(precisions[2], input_shapes[2]);
    auto data3 = std::make_shared<ov::op::v0::Parameter>(precisions[3], input_shapes[3]);
    ...
    auto transpose0Param = std::make_shared<ov::op::v0::Parameter>(precisions[0], input_shapes[0]);
    auto brgemm1Param = std::make_shared<ov::op::v0::Parameter>(subgraph_parent1->get_element_type(), subgraph_parent1->get_output_partial_shape(0));
    auto addParam = std::make_shared<ov::op::v0::Parameter>(precisions[2], input_shapes[2]);
    auto transpose2Param = std::make_shared<ov::op::v0::Parameter>(precisions[3], input_shapes[3]);
...
std::shared_ptr<ov::Model> MHASplitMFunction::initReference() const {
    ...
    auto transpose0Param = std::make_shared<ov::op::v0::Parameter>(precisions[0], reshape0->get_shape());
    auto brgemm1Param = std::make_shared<ov::op::v0::Parameter>(precisions[1], reshape1->get_shape());
    auto addParam = std::make_shared<ov::op::v0::Parameter>(precisions[2], reshape2->get_shape());
    auto transpose2Param = std::make_shared<ov::op::v0::Parameter>(precisions[3], reshape3->get_shape());
    ov::ParameterVector subgraph_params = {transpose0Param, brgemm1Param, addParam, transpose2Param};
...
std::shared_ptr<ov::Model> MHAWithDynamicMulFunction::initOriginal() const {
    auto transpose0Param = std::make_shared<ov::op::v0::Parameter>(precisions[0], input_shapes[0]);
    auto transpose1Param = std::make_shared<ov::op::v0::Parameter>(precisions[1], input_shapes[1]);
    auto mulParam = std::make_shared<ov::op::v0::Parameter>(precisions[2], input_shapes[2]);
    auto addParam = std::make_shared<ov::op::v0::Parameter>(precisions[3], input_shapes[3]);
    auto transpose2Param = std::make_shared<ov::op::v0::Parameter>(precisions[4], input_shapes[4]);
...
std::shared_ptr<ov::Model> MHAMatMul0TransposeFunction::initReference() const {
    ...
    auto transpose0Param = std::make_shared<ov::op::v0::Parameter>(precisions[0], input_shapes[0]);
    auto brgemm1Param = std::make_shared<ov::op::v0::Parameter>(transposeB->get_element_type(), transposeB->get_output_partial_shape(0));
    auto addParam = std::make_shared<ov::op::v0::Parameter>(precisions[2], input_shapes[2]);
    auto transpose2Param = std::make_shared<ov::op::v0::Parameter>(precisions[3], input_shapes[3]);
...
std::shared_ptr<ov::Model> MHASelectFunction::initOriginal() const {
    ...
    auto transpose1Param = std::make_shared<ov::op::v0::Parameter>(precisions[1], input_shapes[1]);
    auto addParam = std::make_shared<ov::op::v0::Parameter>(precisions[2], input_shapes[2]);
    auto less0Param = std::make_shared<ov::op::v0::Parameter>(precisions[3], input_shapes[3]);
    auto less1Param = std::make_shared<ov::op::v0::Parameter>(precisions[4], input_shapes[4]);
    auto transpose2Param = std::make_shared<ov::op::v0::Parameter>(precisions[5], input_shapes[5]);
    ...
    const auto select = std::make_shared<ov::op::v1::Select>(selectCond, selectConst, add,
                                                                 ov::op::AutoBroadcastType::NUMPY);
    const auto reshape0 = std::make_shared<ov::op::v1::Reshape>(select, reshape0Const, true);
    const auto softMax = std::make_shared<ov::op::v1::Softmax>(reshape0, 1);
    const auto reshape1 = std::make_shared<ov::op::v1::Reshape>(softMax, reshape1Const, true);
    const auto transpose2 = std::make_shared<ov::op::v1::Transpose>(transpose2Param, transpose2Const);
...
std::shared_ptr<ov::Model> MHASelectSplitMFunction::initOriginal() const {
    auto transpose0Param = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[0]);
    auto transpose1Param = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[1]);
    auto addParam = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[2]);
    auto selectParam = std::make_shared<ov::op::v0::Parameter>(ov::element::u8, input_shapes[3]);
    auto transpose2Param = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[4]);
    ...
    if (add->get_output_partial_shape(0) != selectParam->get_output_partial_shape(0)) {
        ...
        selectCond = std::make_shared<ov::op::v1::Broadcast>(selectCond, broadcast_shape);
    }
    const auto select = std::make_shared<op::TypeRelaxed<ov::op::v1::Select>>(
    ...
    ov::ResultVector results{std::make_shared<ov::op::v0::Result>(matMul1)};
    return std::make_shared<ov::Model>(results, ngraphParam, "mha");
}

std::shared_ptr<ov::Model> MHASelectSplitMFunction::initReference() const {
    auto param0 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[0]);
    auto param1 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[1]);
    auto addParam = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[2]);
    auto selectParam = std::make_shared<ov::op::v0::Parameter>(ov::element::u8, input_shapes[3]);
    auto param2 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[4]);
    ...
    auto data0 = std::make_shared<ov::op::v0::Parameter>(reshape0->get_element_type(), reshape0->get_shape());
    auto data1 = std::make_shared<ov::op::v0::Parameter>(reshape1->get_element_type(), reshape1->get_shape());
    auto dataAdd = std::make_shared<ov::op::v0::Parameter>(reshapeAdd->get_element_type(), reshapeAdd->get_shape());
    auto dataSelect = std::make_shared<ov::op::v0::Parameter>(reshapeSelect->get_element_type(), reshapeSelect->get_shape());
    auto data2 = std::make_shared<ov::op::v0::Parameter>(reshape2->get_element_type(), reshape2->get_shape());
    ...
    const auto softMax = std::make_shared<ov::op::v1::Softmax>(select, add->get_shape().size() - 1);
    ...
    ov::ResultVector results{std::make_shared<ov::op::v0::Result>(reshape3)};
    return std::make_shared<ov::Model>(results, ngraphParam, "mha");
}
...
std::shared_ptr<ov::Model> MHAWOTransposeOnInputsFunction::initOriginal() const {
    auto param0 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[0]);
    auto param1 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[1]);
    auto param2 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[2]);
...
std::shared_ptr<ov::Model> MHAWOTransposeFunction::initOriginal() const {
    auto param0 = std::make_shared<ov::op::v0::Parameter>(precisions[0], input_shapes[0]);
    auto param1 = std::make_shared<ov::op::v0::Parameter>(precisions[1], input_shapes[1]);
    auto param2 = std::make_shared<ov::op::v0::Parameter>(precisions[2], input_shapes[2]);
    ov::ParameterVector ngraphParam = {param0, param1, param2};
...
std::shared_ptr<ov::Model> MHAWOTransposeSplitMFunction::initReference() const {
    ...
    auto data0 = std::make_shared<ov::op::v0::Parameter>(precisions[0], reshape0->get_shape());
    auto data1 = std::make_shared<ov::op::v0::Parameter>(precisions[1], reshape1->get_shape());
    auto data2 = std::make_shared<ov::op::v0::Parameter>(precisions[2], reshape2->get_shape());
...
std::shared_ptr<ov::Model> MHAFQAfterMatMulFunction::initOriginal() const {
    ...
    auto transpose1Param = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[1]);
    auto addParam = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[2]);
    auto transpose2Param = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[3]);
    ov::ParameterVector ngraphParam = {transpose0Param, transpose1Param, addParam, transpose2Param};
...
std::shared_ptr<ov::Model> MHAFQFunction::initOriginal() const {
    ...
    const auto convert = std::make_shared<ov::op::v0::Convert>(mul_const, ov::element::f32);
    const auto mul_deq_const = ov::op::v0::Constant::create(ov::element::f32, ov::Shape{1}, std::vector<float>{0.00098425});
    const auto mul_deq = std::make_shared<ov::op::v1::Multiply>(convert, mul_deq_const);
    const auto mul = std::make_shared<ov::op::v1::Multiply>(transpose1, mul_deq);
    ...
    const auto add = std::make_shared<ov::op::v1::Add>(fq2, fq_add);
...
std::shared_ptr<ov::Model> MHAINT8MatMulTypeRelaxedFunction::initOriginal() const {
    ...
    const auto reshape0 = std::make_shared<ov::op::v1::Reshape>(deq_mul, reshape0Const, true);
    const auto softMax = std::make_shared<ov::op::v1::Softmax>(reshape0, 1);
    const auto reshape1 = std::make_shared<ov::op::v1::Reshape>(softMax, reshape1Const, true);
...
std::shared_ptr<ov::Model> MHAINT8MatMulTypeRelaxedFunction::initReference() const {
    auto data0 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[0]);
    auto data1 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[1]);
    auto data2 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[2]);
    auto data3 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[3]);
    ov::ParameterVector ngraphParams = {data0, data1, data2, data3};
    ...
    const auto transpose0Param = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[0]);
    const auto brgemm1Param = std::make_shared<ov::op::v0::Parameter>(transpose1->get_element_type(), transpose1->get_output_partial_shape(0));
    const auto addParam = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[2]);
    const auto transpose2Param = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[3]);
    ov::ParameterVector subgraph_params = {transpose0Param, brgemm1Param, addParam, transpose2Param};
    ...
    const auto softMax = std::make_shared<ov::op::v1::Softmax>(deq_mul, 3);
...
std::shared_ptr<ov::Model> MHAMulAddFunction::initOriginal() const {
    auto transpose0Param = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[0]);
    auto transpose1Param = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[1]);
    auto transpose2Param = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[2]);
...
std::shared_ptr<ov::Model> MHATransposedInputFunction::initOriginal() const {
    const auto param0 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[0]);
    const auto param1 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[1]);
    const auto param2 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[2]);
    ov::ParameterVector ngraphParam = {param0, param1, param2};
...
std::shared_ptr<ov::Model> MHATransposedInputFunction::initReference() const {
    const auto data0 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[0]);
    const auto data1 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[1]);
    const auto data2 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[2]);
    ...
    const auto param0 = std::make_shared<ov::op::v0::Parameter>(precision, data0->get_output_partial_shape(0));
    const auto param1 = std::make_shared<ov::op::v0::Parameter>(precision, in1->get_output_partial_shape(0));
    const auto param2 = std::make_shared<ov::op::v0::Parameter>(precision, data2->get_output_partial_shape(0));
    ...
    ov::ResultVector results{std::make_shared<ov::op::v0::Result>(subgraph)};
    return std::make_shared<ov::Model>(results, ngraphParam, "mha");
}

std::shared_ptr<ov::Model> MHAWithExtractedReshapeFunction::initOriginal() const {
    const auto param_0 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[0]);
    const auto param_1 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[1]);
    const auto param_2 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[2]);
    const auto param_3 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[3]);
    const auto param_4 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[4]);
    ...
    if (add_2nd_reshape) {
        ...
        const auto reshape_const = ov::op::v0::Constant::create(ov::element::i32, {target_shape.size()}, target_shape);
        add_input = std::make_shared<ov::op::v1::Reshape>(param_2, reshape_const, false);
    } else {
        add_input = param_2;
    }
    ...
    const auto target_shape_const_1 = ov::op::v0::Constant::create(ov::element::i32, ov::Shape{target_shape.size()}, target_shape);
    const auto reshape_1 = std::make_shared<ov::op::v1::Reshape>(matmul_0, target_shape_const_1, false);

    const auto add_1 = std::make_shared<ov::op::v1::Add>(reshape_1, add_input);
    const auto add_2 = std::make_shared<ov::op::v1::Add>(add_1, param_3);

    const auto& mm_out_shape = matmul_0->get_output_shape(0);
    const auto target_shape_const_2 = ov::op::v0::Constant::create(ov::element::i32, ov::Shape{mm_out_shape.size()}, mm_out_shape);
    const auto reshape_2 = std::make_shared<ov::op::v1::Reshape>(add_2, target_shape_const_2, false);
    ...
    ov::ResultVector results{std::make_shared<ov::op::v0::Result>(matmul_1)};
...
std::shared_ptr<ov::Model> MHAWithExtractedReshapeFunction::initReference() const {
    const auto data_0 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[0]);
    const auto data_1 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[1]);
    const auto data_2 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[2]);
    const auto data_3 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[3]);
    const auto data_4 = std::make_shared<ov::op::v0::Parameter>(precision, input_shapes[4]);
    ...
    if (add_2nd_reshape) {
        ...
        target_shape.push_back(1);
        const auto reshape_const = ov::op::v0::Constant::create(ov::element::i32, {target_shape.size()}, target_shape);
        add_input = std::make_shared<ov::op::v1::Reshape>(data_2, reshape_const, false);
    } else {
        add_input = data_2;
    }

    const auto external_add = std::make_shared<ov::op::v1::Add>(add_input, data_3);
    ov::Shape mm_out_shape = input_shapes[0].to_shape();
    mm_out_shape.back() = input_shapes[1].to_shape().back();
    const auto target_shape = ov::op::v0::Constant::create(ov::element::i32, {mm_out_shape.size()}, mm_out_shape);
    const auto reshape = std::make_shared<ov::op::v1::Reshape>(external_add, target_shape, false);

    const auto param_0 = std::make_shared<ov::op::v0::Parameter>(precision, data_0->get_shape());
    const auto param_1 = std::make_shared<ov::op::v0::Parameter>(precision, data_1->get_shape());
    const auto param_2 = std::make_shared<ov::op::v0::Parameter>(precision, reshape->get_shape());
    const auto param_3 = std::make_shared<ov::op::v0::Parameter>(precision, data_4->get_shape());

    const auto matmul_0 = std::make_shared<ov::op::v0::MatMul>(param_0, param_1);
    const auto add_internal = std::make_shared<ov::op::v1::Add>(matmul_0, param_2);
