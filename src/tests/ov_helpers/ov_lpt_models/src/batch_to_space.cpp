...
std::shared_ptr<ov::Model> BatchToSpaceFunction::get(const ov::PartialShape& input_shape,
    ...
    parent = std::make_shared<ov::op::v1::BatchToSpace>(
        parent,
        std::make_shared<ov::op::v0::Constant>(ov::element::i64, ov::Shape{ block_shape.size() }, block_shape),
        std::make_shared<ov::op::v0::Constant>(ov::element::i64, ov::Shape{ crops_begin.size() }, crops_begin),
        std::make_shared<ov::op::v0::Constant>(ov::element::i64, ov::Shape{ crops_end.size() }, crops_end));
