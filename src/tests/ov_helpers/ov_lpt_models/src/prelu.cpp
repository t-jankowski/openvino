...
std::shared_ptr<ov::Model> PReluFunction::getOriginal(
    ...
    const auto slope = std::make_shared<ov::op::v0::Constant>(precisionBeforeDequantization, Shape{}, std::vector<float> { 0.1f });
    const auto prelu = std::make_shared<ov::op::v0::PRelu>(dequantizationOp, slope);
...
std::shared_ptr<ov::Model> PReluFunction::getOriginal(
    ...
    const auto slope = std::make_shared<ov::op::v0::Constant>(precisionBeforeFq, Shape{}, std::vector<float> { 0.1f });
    const auto prelu = std::make_shared<ov::op::v0::PRelu>(quantizationOp, slope);
...
std::shared_ptr<ov::Model> PReluFunction::getReference(
    ...
    const auto slope = std::make_shared<ov::op::v0::Constant>(precisionBeforeDequantization, Shape{}, std::vector<float> { 0.1f });
    const auto prelu = std::make_shared<ov::op::TypeRelaxed<ov::op::v0::PRelu>>(
        ov::op::v0::PRelu(quantizationOpBefore, slope),
