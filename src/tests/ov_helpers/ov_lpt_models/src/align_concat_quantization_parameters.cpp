...
std::shared_ptr<ov::Model> AlignConcatQuantizationParametersFunction::getOriginal(
    ...
    const auto input1 = std::make_shared<ov::op::v0::Parameter>(inputPrecision, ov::Shape(inputShape));
    std::shared_ptr<ov::Node> parent1 = input1;
    {
        ...
        parent1 = std::make_shared<ov::op::v1::AvgPool>(
            parent1,
            Strides{ 1, 1 },
            Shape{ 1, 1 },
            Shape{ 0, 0 },
        ...
        if (additionalLayer == "maxpool") {
            parent1 = std::make_shared<ov::op::v1::MaxPool>(
                parent1,
                Strides{ 1, 1 },
                Shape{ 1, 1 },
                Shape{ 0, 0 },
    ...
    const auto input2 = std::make_shared<ov::op::v0::Parameter>(inputPrecision, ov::Shape(inputShape));
    std::shared_ptr<ov::Node> parent2 = input2;
    {
        ...
        parent2 = std::make_shared<ov::op::v1::AvgPool>(
            parent2,
            Strides{ 1, 1 },
            Shape{ 1, 1 },
            Shape{ 0, 0 },
        ...
        if (additionalLayer == "maxpool") {
            parent2 = std::make_shared<ov::op::v1::MaxPool>(
                parent2,
                Strides{ 1, 1 },
                Shape{ 1, 1 },
                Shape{ 0, 0 },
    ...
    auto parent = std::dynamic_pointer_cast<ov::Node>(std::make_shared<ov::op::v0::Concat>(ov::OutputVector{ parent1, parent2 }, 1));
...

    {
        ...
        parent = std::make_shared<ov::op::v1::Convolution>(
