...
std::shared_ptr<ov::Model> ElementwiseWithMultiParentDequantizationFunction::get(
    ...
    const auto input1_1 = std::make_shared<ov::op::v0::Parameter>(precision1, inputShape);
    const auto input1_2 = std::make_shared<ov::op::v0::Parameter>(precision1, ov::Shape({ inputShape[0], inputShape[1], 1, 1 }));
    const std::shared_ptr<ov::Node> multiply1 = std::make_shared<ov::op::TypeRelaxed<ov::op::v1::Multiply>>(
        ov::op::v1::Multiply(ov::op::TemporaryReplaceOutputType(input1_1, ov::element::f32).get(),
    ...
    const auto input2_1 = std::make_shared<ov::op::v0::Parameter>(precision1, inputShape);
    const auto input2_2 = std::make_shared<ov::op::v0::Parameter>(precision1, ov::Shape({ inputShape[0], inputShape[1], 1, 1 }));
    const std::shared_ptr<ov::Node> multiply2 = std::make_shared<ov::op::TypeRelaxed<ov::op::v1::Multiply>>(
        ov::op::v1::Multiply(ov::op::TemporaryReplaceOutputType(input2_1, ov::element::f32).get(),
    ...
    const auto add = std::make_shared<ov::op::v1::Add>(parent1, parent2);
