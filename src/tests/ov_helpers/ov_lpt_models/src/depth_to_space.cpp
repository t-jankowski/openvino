...
std::shared_ptr<ov::Model> DepthToSpaceFunction::getOriginal(
    ...
    auto d2s = std::make_shared<ov::op::v0::DepthToSpace>(fakeQuantize, mode, blockSize);
...
std::shared_ptr<ov::Model> DepthToSpaceFunction::getOriginal(
    ...
    auto d2s = std::make_shared<ov::op::v0::DepthToSpace>(dequantizationOp, mode, blockSize);
    d2s->set_friendly_name("output");
...
std::shared_ptr<ov::Model> DepthToSpaceFunction::getReference(
    ...
    auto d2s = std::make_shared<ov::op::v0::DepthToSpace>(dequantizationOpBefore, mode, blockSize);
