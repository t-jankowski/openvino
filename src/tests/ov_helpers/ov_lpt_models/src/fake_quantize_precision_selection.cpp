...
std::shared_ptr<ov::Model> FakeQuantizePrecisionSelectionFunction::getOriginal(
        ...
        std::shared_ptr<ov::Node> branch1Operation =
            values.operationBeforeLimitedOperationIsPrecisionTransparent
                ? std::dynamic_pointer_cast<ov::Node>(
                      std::make_shared<ov::op::v1::MaxPool>(fakeQuantize,
                                                            Strides{1, 1},
                                                            Shape{1, 1},
                                                            Shape{0, 0},
                                                            Shape{2, 2},
                                                            op::RoundingType::FLOOR))
                : std::make_shared<ov::op::TypeRelaxed<ov::op::v0::PRelu>>(
                      ov::op::v0::PRelu(
                          fakeQuantize,
                          std::make_shared<ov::op::v0::Constant>(element::f32, Shape{}, std::vector<float>{0.01})),
                      element::f32);
    ...
    {
        // just another branch
        branch2Last = std::make_shared<ov::op::TypeRelaxed<ov::op::v0::PRelu>>(
            ov::op::v0::PRelu(
                fakeQuantize,
                std::make_shared<ov::op::v0::Constant>(ov::element::f32, Shape{}, std::vector<float>{0.01})),
            ov::element::f32);
    }
...
std::shared_ptr<ov::Model> FakeQuantizePrecisionSelectionFunction::getReference(
    ...
    std::shared_ptr<ov::Node> branch1Pooling =
        values.operationBeforeLimitedOperationIsPrecisionTransparent
            ? std::dynamic_pointer_cast<ov::Node>(std::make_shared<ov::op::v1::MaxPool>(fakeQuantize,
                                                                                        Strides{1, 1},
                                                                                        Shape{1, 1},
                                                                                        Shape{0, 0},
                                                                                        Shape{2, 2},
    ...
    std::shared_ptr<ov::op::v1::Multiply> branch1Multiply = std::make_shared<ov::op::v1::Multiply>(
        convolution,
        std::make_shared<ov::op::v0::Constant>(precision, Shape({}), std::vector<float>({ 0.0001f })));


    // just another branch
    std::shared_ptr<ov::op::v0::PRelu> branch2PRelu = std::make_shared<ov::op::TypeRelaxed<ov::op::v0::PRelu>>(
        fakeQuantize,
        std::make_shared<ov::op::v0::Constant>(ov::element::f32, Shape{}, std::vector<float>{0.01}));

    const std::shared_ptr<ov::Node> branch2Multiply = std::make_shared<ov::op::v1::Multiply>(
        branch2PRelu,
        std::make_shared<ov::op::v0::Constant>(precision, Shape({}), std::vector<float>({0.01f})));
    ...
    if (values.fakeQuantizeOnDataOutPrecision != precision) {
        ...
        if (values.fakeQuantizeOnWeights.empty()) {
            replace_node(
                weights,
                ov::pass::low_precision::fold<ov::op::v0::Convert>(weights, ov::element::i8));
        }
