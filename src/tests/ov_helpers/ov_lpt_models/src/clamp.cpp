...
std::shared_ptr<ov::Model> ClampFunction::getOriginal(
    ...
    const std::shared_ptr<Node> clamp = std::make_shared<ov::op::v0::Clamp>(dequantizationOp, 0, 10);
    clamp->set_friendly_name("output");

    ov::ResultVector results{ std::make_shared<ov::op::v0::Result>(clamp) };
...
std::shared_ptr<ov::Model> ClampFunction::getOriginal(
    ...
    const std::shared_ptr<ov::op::v0::Clamp> clamp = std::make_shared<ov::op::v0::Clamp>(
...
std::shared_ptr<ov::Model> ClampFunction::getWithNonDequantizationMultiply(
    ...
    const auto clamp = std::make_shared<ov::op::v0::Clamp>(multiply, 0.0, 6.0);
    clamp->set_friendly_name("output");
...
std::shared_ptr<ov::Model> ClampFunction::getReference(
    ...
    std::shared_ptr<ov::op::v0::Clamp> clamp = std::make_shared<ov::op::TypeRelaxed<ov::op::v0::Clamp>>(quantizationOpBefore, 0, 10);
