...
std::shared_ptr<ov::Model> MarkupBiasFunction::get(const ov::element::Type& precision,
    ...
    auto il = ov::op::v0::Constant::create(precision, {}, {0.f});
    auto ih = ov::op::v0::Constant::create(precision, {}, {12.5f});
    auto ol = ov::op::v0::Constant::create(precision, {}, {0.f});
    auto oh = ov::op::v0::Constant::create(precision, {}, {12.5f});
    auto fq = std::make_shared<ov::op::v0::FakeQuantize>(input_params[0], il, ih, ol, oh, 256);
    ...
    if (layer_type == "Convolution") {
        ...
        auto convert = std::make_shared<ov::op::v0::Convert>(weights, precision);
        auto mul_const = ov::test::utils::make_constant(precision, Shape{1, 1, 1, 1});
        auto mul = std::make_shared<ov::op::v1::Multiply>(convert, mul_const);

        const ov::Strides strides = {1, 1};
        const ov::CoordinateDiff pads_begin = {0, 0};
        const ov::CoordinateDiff pads_end = {0, 0};
        const ov::Strides dilations = {1, 1};
        layer = std::make_shared<ov::op::v1::Convolution>(fq, mul, strides, pads_begin, pads_end, dilations);
        ...
        auto reshape_const = ov::op::v0::Constant::create(ov::element::i32, {5}, target_shape);
        auto reshape = std::make_shared<ov::op::v1::Reshape>(mul, reshape_const, true);

        const ov::Strides strides = {1, 1};
        const ov::CoordinateDiff pads_begin = {0, 0};
        const ov::CoordinateDiff pads_end = {0, 0};
        const ov::Strides dilations = {1, 1};
        layer = std::make_shared<ov::op::v1::GroupConvolution>(fq, reshape, strides, pads_begin, pads_end, dilations);
        ...
        const ov::CoordinateDiff pads_end = {0, 0};
        const ov::Strides dilations = {1, 1};
        layer = std::make_shared<ov::op::v1::ConvolutionBackpropData>(fq, mul, strides, pads_begin, pads_end, dilations);
    } else if (layer_type == "MatMul") {
        auto new_param = std::make_shared<ov::op::v0::Parameter>(precision, input_shape);
        input_params.push_back(new_param);
        auto il_2 = ov::op::v0::Constant::create(precision, {}, {-128.f});
        auto ih_2 = ov::op::v0::Constant::create(precision, {}, {127.f});
        auto ol_2 = ov::op::v0::Constant::create(precision, {}, {-128.f});
        auto oh_2 = ov::op::v0::Constant::create(precision, {}, {127.f});
        auto fq_2 = std::make_shared<ov::op::v0::FakeQuantize>(new_param, il_2, ih_2, ol_2, oh_2, 256);
        layer = std::make_shared<ov::op::v0::MatMul>(fq, fq_2, false, true);
        ...
        auto mul = std::make_shared<ov::op::v1::Multiply>(convert, mul_const);
        layer = std::make_shared<ov::op::v0::MatMul>(fq, mul, false, true);
    } else {
    ...
    if (extra_multipy) {
        ...
        add_input0 = std::make_shared<ov::op::v1::Multiply>(layer, mul_input);
    }
    ...
    auto add = std::make_shared<ov::op::v1::Add>(add_input0, add_input1);
