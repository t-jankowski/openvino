...
TEST_P(ExecGrapDecomposeNormalizeL2, CheckIfDecomposeAppliedForNonContiguousAxes) {
      ...
      const auto input = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ov::PartialShape{3, 4, 5});
      const auto axes_const = ov::op::v0::Constant::create(ov::element::i64, ov::Shape{2}, {0, 2});
      const auto normalize_l2 = std::make_shared<ov::op::v0::NormalizeL2>(input, axes_const, eps_value, ov::op::EpsMode::MAX);
...
TEST_P(ExecGrapDecomposeNormalizeL2, CheckIfDecomposeAppliedForNormalizeOverAllAxes) {
      ...
      const float eps_value = 0.000099f;
      const auto input = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ov::PartialShape{3, 4, 5});
      const auto axes_const = ov::op::v0::Constant::create(ov::element::i64, ov::Shape{3}, {0, 1, 2});
      const auto normalize_l2 = std::make_shared<ov::op::v0::NormalizeL2>(input, axes_const, eps_value, ov::op::EpsMode::MAX);
...
TEST_P(ExecGrapDecomposeNormalizeL2, CheckIfDecomposeNotAppliedForNotSorted) {
      ...
      const float eps_value = 0.000099f;
      const auto input = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ov::PartialShape{2, 1});
      const auto axes_const = ov::op::v0::Constant::create(ov::element::i64, ov::Shape{1}, {1});
      const auto normalize_l2 = std::make_shared<ov::op::v0::NormalizeL2>(input, axes_const, eps_value, ov::op::EpsMode::ADD);
...
TEST_P(ExecGrapDecomposeNormalizeL2, CheckIfDecomposeNotAppliedForSingleAxis) {
      ...
      const float eps_value = 0.000099f;
      const auto input = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ov::PartialShape{1, 2, 3});
      const auto axes_const = ov::op::v0::Constant::create(ov::element::i64, ov::Shape{1}, {1});
      const auto normalize_l2 = std::make_shared<ov::op::v0::NormalizeL2>(input, axes_const, eps_value, ov::op::EpsMode::ADD);
