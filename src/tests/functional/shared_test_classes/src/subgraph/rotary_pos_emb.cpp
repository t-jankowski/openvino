...
std::shared_ptr<ov::Model> RoPETestFlux::build_rope_flux(int batch,
    ...
    auto x = std::make_shared<ov::op::v0::Parameter>(element_type, PartialShape{batch, num_head, seq_length, ndims});
    auto t_cos = std::make_shared<ov::op::v0::Parameter>(element_type, PartialShape{1, 1, seq_length, ndims});
    auto t_sin = std::make_shared<ov::op::v0::Parameter>(element_type, PartialShape{1, 1, seq_length, ndims});
...
std::shared_ptr<ov::Model> RoPETestLlama2StridedSlice::buildROPE_Llama2(int batch,
                                                                        ...
                                                                        int num_head,
                                                                        int ndims) {
    auto input = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, PartialShape{batch, -1, num_head, ndims});
    auto pos_id_end = std::make_shared<ov::op::v0::Parameter>(ov::element::i32, ov::Shape{});
    auto pos_ids = std::make_shared<ov::op::v0::Parameter>(ov::element::i32, PartialShape{1, -1});
...
std::shared_ptr<ov::Model> RoPETestChatGLMStridedSlice::buildROPE_ChatGLM(int batch, int head_cnt, int rotary_dims, ov::element::Type element_type) {
    auto input = std::make_shared<ov::op::v0::Parameter>(element_type, PartialShape{-1, batch, 4096 + 256 + 256});
    auto cos_sin_cache = std::make_shared<ov::op::v0::Parameter>(element_type, PartialShape{32768, 32, 2});
    auto position_ids = std::make_shared<ov::op::v0::Parameter>(ov::element::i32, PartialShape{-1, -1});

    auto __module_transformer_index_67_Gather =
        makeOP<op::v8::Gather>({cos_sin_cache, position_ids, 0}, {{"batch_dims", 0}});
    auto __module_transformer_transpose_Transpose =
        makeOP<op::v1::Transpose>({__module_transformer_index_67_Gather, {1, 0, 2, 3}});
    auto size_ShapeOf_110 =
        makeOP<op::v3::ShapeOf>({__module_transformer_transpose_Transpose}, {{"output_type", "i32"}});
    auto __getitem___Gather = makeOP<op::v8::Gather>({size_ShapeOf_110, -2, 0}, {{"batch_dims", 0}});
    auto mul_Multiply = makeOP<op::v1::Multiply>({__getitem___Gather, 2}, {{"auto_broadcast", "numpy"}});
    auto slice_Unsqueeze_112 = makeOP<op::v0::Unsqueeze>({mul_Multiply, 0});

    auto floordiv_Divide =
        makeOP<op::v1::Divide>({mul_Multiply, 2}, {{"auto_broadcast", "numpy"}, {"m_pythondiv", true}});
    auto floordiv_Floor = makeOP<op::v0::Floor>({floordiv_Divide});
    auto ListConstruct_126_Reshape_2 = makeOP<op::v1::Reshape>({floordiv_Floor, {-1}}, {{"special_zero", false}});

    auto ListUnpack_321 = makeOP<op::v1::VariadicSplit>({input, -1, {4096, 256, 256}});
    auto view_Reshape = makeOP<op::v1::Reshape>({ListUnpack_321->output(0), {0, 0, 32, 128}}, {{"special_zero", true}});

    auto ScatterUpdate_229053 = makeOP<op::v3::ScatterUpdate>({{0, 0, 0, 0}, {3}, slice_Unsqueeze_112, {0}});
    auto slice_Slice_357 =
        makeOP<op::v1::StridedSlice>({view_Reshape, {0, 0, 0, 0}, ScatterUpdate_229053, {1, 1, 1, 1}},
                                     {{"begin_mask", {1, 1, 1, 0}},
                                      {"end_mask", {1, 1, 1, 0}},
                                      {"new_axis_mask", {}},
                                      {"shrink_axis_mask", {}},
                                      {"ellipsis_mask", {}}});
    auto size_ShapeOf_346 = makeOP<op::v3::ShapeOf>({view_Reshape}, {{"output_type", "i32"}});
    auto size_Gather_348 = makeOP<op::v8::Gather>({size_ShapeOf_346, 0, 0}, {{"batch_dims", 0}});
    auto ListConstruct_372_Reshape = makeOP<op::v1::Reshape>({size_Gather_348, {-1}}, {{"special_zero", false}});
    auto size_Gather_351 = makeOP<op::v8::Gather>({size_ShapeOf_346, {2}, 0}, {{"batch_dims", 0}});
    auto ListConstruct_372_Concat =
        makeOP<op::v0::Concat>({ListConstruct_372_Reshape, {-1}, size_Gather_351, ListConstruct_126_Reshape_2, {2}},
                               {{"axis", 0}});
    auto reshape_Reshape_373 =
        makeOP<op::v1::Reshape>({slice_Slice_357, ListConstruct_372_Concat}, {{"special_zero", false}});
    auto select_Gather_381 = makeOP<op::v8::Gather>({reshape_Reshape_373, 0, -1}, {{"batch_dims", 0}});
    auto slice_Unsqueeze_367 = makeOP<op::v0::Unsqueeze>({size_Gather_348, 0});
    auto slice_Slice_369 =
        makeOP<op::v1::StridedSlice>({__module_transformer_transpose_Transpose, {0}, slice_Unsqueeze_367, {1}},
                                     {{"begin_mask", {0}},
                                      {"end_mask", {0}},
                                      {"new_axis_mask", {}},
                                      {"shrink_axis_mask", {}},
                                      {"ellipsis_mask", {}}});
    auto size_ShapeOf_374 = makeOP<op::v3::ShapeOf>({reshape_Reshape_373}, {{"output_type", "i32"}});
    auto size_Gather_376 = makeOP<op::v8::Gather>({size_ShapeOf_374, {3}, 0}, {{"batch_dims", 0}});
    auto ListConstruct_379_Concat =
        makeOP<op::v0::Concat>({ListConstruct_372_Reshape, {-1}, {1}, size_Gather_376, {2}}, {{"axis", 0}});
    auto view_Reshape_380 =
        makeOP<op::v1::Reshape>({slice_Slice_369, ListConstruct_379_Concat}, {{"special_zero", false}});
    auto select_Gather_382 = makeOP<op::v8::Gather>({view_Reshape_380, 0, -1}, {{"batch_dims", 0}});
    auto mul_Multiply_383 =
        makeOP<op::v1::Multiply>({select_Gather_381, select_Gather_382}, {{"auto_broadcast", "numpy"}});
    auto select_Gather_384 = makeOP<op::v8::Gather>({reshape_Reshape_373, 1, -1}, {{"batch_dims", 0}});
    auto select_Gather_385 = makeOP<op::v8::Gather>({view_Reshape_380, 1, -1}, {{"batch_dims", 0}});
    auto mul_Multiply_386 =
        makeOP<op::v1::Multiply>({select_Gather_384, select_Gather_385}, {{"auto_broadcast", "numpy"}});
    auto sub_Subtract_389 =
        makeOP<op::v1::Subtract>({mul_Multiply_383, mul_Multiply_386}, {{"auto_broadcast", "numpy"}});
    auto Unsqueeze_62716 = makeOP<op::v0::Unsqueeze>({sub_Subtract_389, -1});
    auto mul_Multiply_391 =
        makeOP<op::v1::Multiply>({select_Gather_384, select_Gather_382}, {{"auto_broadcast", "numpy"}});
    auto mul_Multiply_393 =
        makeOP<op::v1::Multiply>({select_Gather_381, select_Gather_385}, {{"auto_broadcast", "numpy"}});
    auto add_Add_396 = makeOP<op::v1::Add>({mul_Multiply_391, mul_Multiply_393}, {{"auto_broadcast", "numpy"}});
    auto Unsqueeze_62717 = makeOP<op::v0::Unsqueeze>({add_Add_396, -1});
    auto stack_401 = makeOP<op::v0::Concat>({Unsqueeze_62716, Unsqueeze_62717}, {{"axis", -1}});
    auto flatten_ShapeOf_402 = makeOP<op::v3::ShapeOf>({stack_401}, {{"output_type", "i32"}});
    auto flatten_Slice_417 = makeOP<op::v1::StridedSlice>({flatten_ShapeOf_402, {0}, {3}, {1}},
                                                          {{"begin_mask", {0}},
                                                           {"end_mask", {0}},
                                                           {"new_axis_mask", {}},
                                                           {"shrink_axis_mask", {}},
                                                           {"ellipsis_mask", {}}});
    auto flatten_Concat_420 = makeOP<op::v0::Concat>({flatten_Slice_417, {-1}}, {{"axis", 0}});
    auto flatten_Reshape_421 = makeOP<op::v1::Reshape>({stack_401, flatten_Concat_420}, {{"special_zero", true}});
    auto ScatterUpdate_229067 = makeOP<op::v3::ScatterUpdate>({{0, 0, 0, 0}, {3}, slice_Unsqueeze_112, {0}});
    auto slice_Slice_363 =
        makeOP<op::v1::StridedSlice>({view_Reshape, ScatterUpdate_229067, {0, 0, 0, INT_MAX}, {1, 1, 1, 1}},
                                     {{"begin_mask", {1, 1, 1, 0}},
                                      {"end_mask", {1, 1, 1, 0}},
                                      {"new_axis_mask", {}},
                                      {"shrink_axis_mask", {}},
                                      {"ellipsis_mask", {}}});
    auto cat_Concat_425 = makeOP<op::v0::Concat>({flatten_Reshape_421, slice_Slice_363}, {{"axis", -1}});
...
std::shared_ptr<ov::Model> RoPETestQwen7bStridedSlice::buildROPE_QWen7b(bool specialReshape, ov::element::Type element_type) {
    auto input = std::make_shared<ov::op::v0::Parameter>(element_type, PartialShape{-1, -1, 4096 + 4096 + 4096});
    auto cos_cache = std::make_shared<ov::op::v0::Parameter>(element_type, PartialShape{1, -1, 1, 128});
    auto sin_cache = std::make_shared<ov::op::v0::Parameter>(element_type, PartialShape{1, -1, 1, 128});

    auto ListUnpack_389_VariadicSplit = makeOP<op::v1::VariadicSplit>({input, 2, {4096, 4096, -1}});
    auto view_Reshape =
        makeOP<op::v1::Reshape>({ListUnpack_389_VariadicSplit->output(0), {0, 0, 32, 128}}, {{"special_zero", true}});
    auto size_ShapeOf_414 = makeOP<op::v3::ShapeOf>({view_Reshape}, {{"output_type", "i32"}});
    auto size_Gather_416 = makeOP<op::v8::Gather>({size_ShapeOf_414, 1, 0}, {{"batch_dims", 0}});
    auto neg_Multiply = makeOP<op::v1::Multiply>({size_Gather_416, -1}, {{"auto_broadcast", "numpy"}});
    auto slice_Unsqueeze_422 = makeOP<op::v0::Unsqueeze>({neg_Multiply, 0});
    auto ScatterUpdate_261437 = makeOP<op::v3::ScatterUpdate>({{0, 0}, {1}, slice_Unsqueeze_422, {0}});
    auto slice_Slice_425 = makeOP<op::v1::StridedSlice>({cos_cache, ScatterUpdate_261437, {0ll, LLONG_MAX}, {1, 1}},
                                                        {{"begin_mask", {1, 0}},
                                                         {"end_mask", {1, 0}},
                                                         {"new_axis_mask", {}},
                                                         {"shrink_axis_mask", {}},
                                                         {"ellipsis_mask", {}}});
    auto slice_Slice_431 = makeOP<op::v1::StridedSlice>({slice_Slice_425, {0, 0, 0}, {0ll, 0ll, LLONG_MAX}, {1, 1, 1}},
                                                        {{"begin_mask", {1, 1, 0}},
                                                         {"end_mask", {1, 1, 0}},
                                                         {"new_axis_mask", {}},
                                                         {"shrink_axis_mask", {}},
    ...
    auto slice_Slice_437 =
        makeOP<op::v1::StridedSlice>({slice_Slice_431, {0, 0, 0, 0}, {0ll, 0ll, 0ll, LLONG_MAX}, {1, 1, 1, 1}},
                                     {{"begin_mask", {1, 1, 1, 0}},
                                      {"end_mask", {1, 1, 1, 0}},
                                      {"new_axis_mask", {}},
                                      {"shrink_axis_mask", {}},
                                      {"ellipsis_mask", {}}});
    auto size_ShapeOf_462 = makeOP<op::v3::ShapeOf>({slice_Slice_437}, {{"output_type", "i32"}});
    auto size_Gather_464 = makeOP<op::v8::Gather>({size_ShapeOf_462, {3}, 0}, {{"batch_dims", 0}});
    auto ScatterUpdate_261533 = makeOP<op::v3::ScatterUpdate>({{0, 0, 0, 0}, {3}, size_Gather_464, {0}});
    auto slice_Slice_470 =
        makeOP<op::v1::StridedSlice>({view_Reshape, {0, 0, 0, 0}, ScatterUpdate_261533, {1, 1, 1, 1}},
                                     {{"begin_mask", {1, 1, 1, 0}},
                                      {"end_mask", {1, 1, 1, 0}},
                                      {"new_axis_mask", {}},
                                      {"shrink_axis_mask", {}},
                                      {"ellipsis_mask", {}}});
    auto mul_Multiply = makeOP<op::v1::Multiply>({slice_Slice_470, slice_Slice_437}, {{"auto_broadcast", "numpy"}});
    auto size_ShapeOf_478 = makeOP<op::v3::ShapeOf>({slice_Slice_470}, {{"output_type", "i32"}});
    auto Gather_239390 = makeOP<op::v8::Gather>({size_ShapeOf_478, {0, 1, 2}, 0}, {{"batch_dims", 0}});
    auto size_Gather_489 = makeOP<op::v8::Gather>({size_ShapeOf_478, 3, 0}, {{"batch_dims", 0}});
    auto floor_divide_Divide =
        makeOP<op::v1::Divide>({size_Gather_489, 2}, {{"auto_broadcast", "numpy"}, {"m_pythondiv", true}});
    auto floor_divide_Floor = makeOP<op::v0::Floor>({floor_divide_Divide});
    auto ListConstruct_493_Reshape_3 = makeOP<op::v1::Reshape>({floor_divide_Floor, {-1}}, {{"special_zero", false}});
    auto ListConstruct_493_Concat =
        makeOP<op::v0::Concat>({Gather_239390, {2}, ListConstruct_493_Reshape_3}, {{"axis", 0}});
    std::shared_ptr<ov::Node> reshape_Reshape = nullptr;
    if (specialReshape) {
        reshape_Reshape = makeOP<op::v1::Reshape>({slice_Slice_470, {0, 0, 32, 2, 64}}, {{"special_zero", true}});
    } else {
        reshape_Reshape =
            makeOP<op::v1::Reshape>({slice_Slice_470, ListConstruct_493_Concat}, {{"special_zero", false}});
    }
    auto ListUnpack_496_Split = makeOP<op::v1::Split>({reshape_Reshape, -2}, {{"num_splits", 2}});
    auto ListUnpack_496_Squeeze_0 = makeOP<op::v0::Squeeze>({ListUnpack_496_Split->output(1), -2});
    auto Constant_296840_compressed = makeConst(element::f16,
                                                ...
                                                {-1});
    auto Constant_296840 = makeOP<op::v0::Convert>({Constant_296840_compressed}, {{"destination_type", element_type.to_string()}});
    auto neg_Multiply_499 =
        makeOP<op::v1::Multiply>({ListUnpack_496_Squeeze_0, Constant_296840}, {{"auto_broadcast", "numpy"}});
    auto ListUnpack_496_Squeeze = makeOP<op::v0::Squeeze>({ListUnpack_496_Split->output(0), -2});
    auto cat_Concat = makeOP<op::v0::Concat>({neg_Multiply_499, ListUnpack_496_Squeeze}, {{"axis", -1}});
    auto slice_Slice_449 = makeOP<op::v1::StridedSlice>({sin_cache, ScatterUpdate_261437, {0ll, LLONG_MAX}, {1, 1}},
                                                        {{"begin_mask", {1, 0}},
                                                         {"end_mask", {1, 0}},
                                                         {"new_axis_mask", {}},
                                                         {"shrink_axis_mask", {}},
                                                         {"ellipsis_mask", {}}});
    auto slice_Slice_455 = makeOP<op::v1::StridedSlice>({slice_Slice_449, {0, 0, 0}, {0ll, 0ll, LLONG_MAX}, {1, 1, 1}},
                                                        {{"begin_mask", {1, 1, 0}},
                                                         {"end_mask", {1, 1, 0}},
                                                         {"new_axis_mask", {}},
                                                         {"shrink_axis_mask", {}},
    ...
    auto slice_Slice_461 =
        makeOP<op::v1::StridedSlice>({slice_Slice_455, {0, 0, 0, 0}, {0ll, 0ll, 0ll, LLONG_MAX}, {1, 1, 1, 1}},
                                     {{"begin_mask", {1, 1, 1, 0}},
                                      {"end_mask", {1, 1, 1, 0}},
                                      {"new_axis_mask", {}},
                                      {"shrink_axis_mask", {}},
                                      {"ellipsis_mask", {}}});
    auto mul_Multiply_503 = makeOP<op::v1::Multiply>({cat_Concat, slice_Slice_461}, {{"auto_broadcast", "numpy"}});
    auto add_Add = makeOP<op::v1::Add>({mul_Multiply, mul_Multiply_503}, {{"auto_broadcast", "numpy"}});
...
std::shared_ptr<ov::Model> RoPETestGPTJStridedSlice::buildROPE_GPTJ(int num_head,
    ...
    auto input = std::make_shared<ov::op::v0::Parameter>(element_type, PartialShape{-1, -1, num_head, hidden_dims});
    auto sincos = std::make_shared<ov::op::v0::Parameter>(element_type, PartialShape{-1, -1, rotary_dims});
    ...
    auto unsqueeze_sin = makeOP<op::v0::Unsqueeze>({varsplit->output(0), 2});
    auto unsqueeze_cos = makeOP<op::v0::Unsqueeze>({varsplit->output(1), 2});
    ...
    auto constant_155588 = makeConst(element_type,
                                     ...
                                     {-1.000000f});
    auto repeat_interleave_sin = makeOP<op::v8::Gather>({unsqueeze_sin, const_idx, 3}, {{"batch_dims", 0}});
    auto repeat_interleave_cos = makeOP<op::v8::Gather>({unsqueeze_cos, const_idx, 3}, {{"batch_dims", 0}});
    ...
    auto neg_Multiply_1177 =
        makeOP<op::v1::Multiply>({slice_Slice_1174, constant_155588}, {{"auto_broadcast", "numpy"}});
    auto Unsqueeze_65524 = makeOP<op::v0::Unsqueeze>({neg_Multiply_1177, -1});
    ...
    auto slice_Slice_1168 =
        makeOP<ov::op::v1::StridedSlice>({slice_Slice_965, {0, 0, 0, 0}, {0, 0, 0, int32_max}, {1, 1, 1, 2}},
                                         {{"begin_mask", {1, 1, 1, 0}},
                                          ...
                                          {"shrink_axis_mask", {}},
                                          {"ellipsis_mask", {}}});
    auto Unsqueeze_65525 = makeOP<op::v0::Unsqueeze>({slice_Slice_1168, -1});
    auto stack_1182 = makeOP<op::v0::Concat>({Unsqueeze_65524, Unsqueeze_65525}, {{"axis", -1}});
    auto flatten_Reshape_1198 =
        makeOP<op::v1::Reshape>({stack_1182, {0, 0, num_head, rotary_dims}}, {{"special_zero", true}});
    // x*cos [B,L,H,ndims]
    auto mul_cos = makeOP<op::v1::Multiply>({slice_Slice_965, repeat_interleave_cos}, {{"auto_broadcast", "numpy"}});
    mul_cos->set_friendly_name("mul_cos");
    auto mul_sin =
        makeOP<op::v1::Multiply>({flatten_Reshape_1198, repeat_interleave_sin}, {{"auto_broadcast", "numpy"}});
    // *cos + *sin
    auto rotary_emb = makeOP<op::v1::Add>({mul_cos, mul_sin}, {{"auto_broadcast", "numpy"}});
    ...
    auto slice_Slice_971 =
        makeOP<ov::op::v1::StridedSlice>({input, {0, 0, 0, rotary_dims}, {0, 0, 0, int32_max}, {1, 1, 1, 1}},
                                         {{"begin_mask", {1, 1, 1, 0}},
                                          ...
                                          {"shrink_axis_mask", {}},
                                          {"ellipsis_mask", {}}});
    auto cat_Concat_1211 = makeOP<op::v0::Concat>({rotary_emb, slice_Slice_971}, {{"axis", -1}});
    auto permute_Transpose_1213 = makeOP<op::v1::Transpose>({cat_Concat_1211, {0, 2, 1, 3}});
    ov::NodeVector model_output = {permute_Transpose_1213};
    if (hasShapeOf) {
        auto shapeOf = makeOP<op::v0::ShapeOf>({rotary_emb}, {{"output_type", "i32"}});
        auto gather = makeOP<op::v8::Gather>({shapeOf, {1}, 0}, {{"batch_dims", 0}});
...
std::shared_ptr<ov::Model> RoPETestRotateHalfWithoutTranspose::buildROPE_RotateHalfWithoutTranspose(
    ...
    int num_head,
    int ndims) {
    auto input = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, PartialShape{batch, num_head, -1, ndims});
    auto pos_id_end = std::make_shared<ov::op::v0::Parameter>(ov::element::i32, ov::Shape{});
    auto pos_ids = std::make_shared<ov::op::v0::Parameter>(ov::element::i32, PartialShape{1, -1});
...
std::shared_ptr<ov::Model> RoPETestChatGLMSlice::buildROPE_ChatGLM(int batch, int head_cnt, int rotary_dims, ov::element::Type element_type) {
    ...
    auto slice_Slice_357 = makeOP<op::v8::Slice>({view_Reshape, {0}, slice_Unsqueeze_112, {1}, {3}});
    auto size_ShapeOf_346 = makeOP<op::v3::ShapeOf>({view_Reshape}, {{"output_type", "i32"}});
    auto size_Gather_348 = makeOP<op::v8::Gather>({size_ShapeOf_346, 0, 0}, {{"batch_dims", 0}});
    auto ListConstruct_372_Reshape = makeOP<op::v1::Reshape>({size_Gather_348, {-1}}, {{"special_zero", false}});
    auto size_Gather_351 = makeOP<op::v8::Gather>({size_ShapeOf_346, {2}, 0}, {{"batch_dims", 0}});
    ...
    auto select_Gather_381 = makeOP<op::v8::Gather>({reshape_Reshape_373, 0, -1}, {{"batch_dims", 0}});
    auto slice_Unsqueeze_367 = makeOP<op::v0::Unsqueeze>({size_Gather_348, 0});
    auto slice_Slice_369 = makeOP<op::v8::Slice>({__module_transformer_transpose_Transpose, {0}, slice_Unsqueeze_367, {1}, {0}});
    auto size_ShapeOf_374 = makeOP<op::v3::ShapeOf>({reshape_Reshape_373}, {{"output_type", "i32"}});
    auto size_Gather_376 = makeOP<op::v8::Gather>({size_ShapeOf_374, {3}, 0}, {{"batch_dims", 0}});
    auto ListConstruct_379_Concat =
        makeOP<op::v0::Concat>({ListConstruct_372_Reshape, {-1}, {1}, size_Gather_376, {2}}, {{"axis", 0}});
    ...
    auto stack_401 = makeOP<op::v0::Concat>({Unsqueeze_62716, Unsqueeze_62717}, {{"axis", -1}});
    auto flatten_ShapeOf_402 = makeOP<op::v3::ShapeOf>({stack_401}, {{"output_type", "i32"}});
    auto flatten_Slice_417 = makeOP<op::v8::Slice>({flatten_ShapeOf_402, {0}, {3}, {1}, {0}});
    auto flatten_Concat_420 = makeOP<op::v0::Concat>({flatten_Slice_417, {-1}}, {{"axis", 0}});
    auto flatten_Reshape_421 = makeOP<op::v1::Reshape>({stack_401, flatten_Concat_420}, {{"special_zero", true}});
    auto slice_Slice_363 = makeOP<op::v8::Slice>({view_Reshape, slice_Unsqueeze_112, {INT_MAX}, {1}, {3}});
    auto cat_Concat_425 = makeOP<op::v0::Concat>({flatten_Reshape_421, slice_Slice_363}, {{"axis", -1}});
    return std::make_shared<ov::Model>(ov::NodeVector{cat_Concat_425},
                                       ov::ParameterVector{input, cos_sin_cache, position_ids});
}
...
std::shared_ptr<ov::Model> RoPETestQwen7bSlice::buildROPE_Qwen7b(bool specialReshape, ov::element::Type element_type) {
    ...
    auto neg_Multiply = makeOP<op::v1::Multiply>({size_Gather_416, -1}, {{"auto_broadcast", "numpy"}});
    auto slice_Unsqueeze_422 = makeOP<op::v0::Unsqueeze>({neg_Multiply, 0});
    auto slice_Slice_425 = makeOP<op::v8::Slice>({cos_cache, slice_Unsqueeze_422, {LLONG_MAX}, {1}, {1}});
    auto size_ShapeOf_462 = makeOP<op::v3::ShapeOf>({slice_Slice_425}, {{"output_type", "i32"}});
    auto size_Gather_464 = makeOP<op::v8::Gather>({size_ShapeOf_462, {3}, 0}, {{"batch_dims", 0}});
    auto slice_Slice_470 = makeOP<op::v8::Slice>({view_Reshape, {0}, size_Gather_464, {1}, {3}});
    auto mul_Multiply = makeOP<op::v1::Multiply>({slice_Slice_470, slice_Slice_425}, {{"auto_broadcast", "numpy"}});
    auto size_ShapeOf_478 = makeOP<op::v3::ShapeOf>({slice_Slice_470}, {{"output_type", "i32"}});
    auto Gather_239390 = makeOP<op::v8::Gather>({size_ShapeOf_478, {0, 1, 2}, 0}, {{"batch_dims", 0}});
    auto size_Gather_489 = makeOP<op::v8::Gather>({size_ShapeOf_478, 3, 0}, {{"batch_dims", 0}});
    auto floor_divide_Divide =
    ...
    auto ListUnpack_496_Squeeze = makeOP<op::v0::Squeeze>({ListUnpack_496_Split->output(0), -2});
    auto cat_Concat = makeOP<op::v0::Concat>({neg_Multiply_499, ListUnpack_496_Squeeze}, {{"axis", -1}});
    auto slice_Slice_449 = makeOP<op::v8::Slice>({sin_cache, slice_Unsqueeze_422, {LLONG_MAX}, {1}, {1}});
    auto mul_Multiply_503 = makeOP<op::v1::Multiply>({cat_Concat, slice_Slice_449}, {{"auto_broadcast", "numpy"}});
    auto add_Add = makeOP<op::v1::Add>({mul_Multiply, mul_Multiply_503}, {{"auto_broadcast", "numpy"}});
    return std::make_shared<ov::Model>(ov::NodeVector{add_Add}, ov::ParameterVector{input, cos_cache, sin_cache});
}
...
std::shared_ptr<ov::Model> RoPETestChatGLM2DRoPEStridedSlice::buildROPE_ChatGLM(int batch, int head_cnt, int rotary_dims, ov::element::Type element_type) {
    auto input = std::make_shared<ov::op::v0::Parameter>(element_type, PartialShape{batch, -1, 4096 + 256 + 256});
    auto cos_sin_cache = std::make_shared<ov::op::v0::Parameter>(element_type, PartialShape{32768, 32, 2});
    auto position_ids = std::make_shared<ov::op::v0::Parameter>(ov::element::i32, PartialShape{-1, -1});
    ...
    auto permute_Transpose = makeOP<op::v1::Transpose>({view_Reshape, {0, 2, 1, 3}}, {});

    auto slice_Slice_357 =
        makeOP<op::v1::StridedSlice>({permute_Transpose, {0, 0, 0, 0}, {0, 0, 0, 64}, {1, 1, 1, 1}},
                                     {{"begin_mask", {1, 1, 1, 0}},
                                      {"end_mask", {1, 1, 1, 0}},
                                      {"new_axis_mask", {}},
                                      {"shrink_axis_mask", {}},
    ...
    auto aten_view_Reshape_1 = makeOP<op::v1::Reshape>({ListUnpack_321->output(1), {0, 0, 2, 128}}, {{"special_zero", true}});
    auto aten_transpose_1 = makeOP<op::v1::Transpose>({aten_view_Reshape_1, {0, 2, 1, 3}});
    auto shape_of_105249 = makeOP<op::v3::ShapeOf>({aten_transpose_1}, {{"output_type", "i32"}});
    auto gather_105252 = makeOP<op::v8::Gather>({shape_of_105249, {2}, {0}}, {{"batch_dims", 0}});
    auto scatter_update_63441 = makeOP<op::v3::ScatterUpdate>({{0, 0}, {1}, gather_105252, {0}});
    // connected to cos_sin_cache
    auto slice_Slice_369 =
        makeOP<op::v1::StridedSlice>({__module_transformer_index_67_Gather, {0, 0}, scatter_update_63441, {1, 1}},
                                     {{"begin_mask", {1, 0}},
                                      {"end_mask", {1, 0}},
                                      {"new_axis_mask", {}},
                                      {"shrink_axis_mask", {}},
                                      {"ellipsis_mask", {}}});
    auto list_construct_concat_1 = makeOP<op::v0::Concat>({{-1}, {1}, gather_105252, {32}, {2}}, {{"axis", 0}});

    auto reshape_Reshape_373 =
        makeOP<op::v1::Reshape>({slice_Slice_357, {0, 32, 0, 32, 2}}, {{"special_zero", true}});
    auto select_Gather_384 = makeOP<op::v8::Gather>({reshape_Reshape_373, 0, -1}, {{"batch_dims", 0}});//x_even
    auto select_Gather_381 = makeOP<op::v8::Gather>({reshape_Reshape_373, 1, -1}, {{"batch_dims", 0}});//x_odd

    auto view_Reshape_380 =
        makeOP<op::v1::Reshape>({slice_Slice_369, list_construct_concat_1}, {{"special_zero", false}});
    auto select_Gather_385 = makeOP<op::v8::Gather>({view_Reshape_380, 0, -1}, {{"batch_dims", 0}});//cos_tab
    auto select_Gather_382 = makeOP<op::v8::Gather>({view_Reshape_380, 1, -1}, {{"batch_dims", 0}});//sin_tab

    auto mul_Multiply_386 =
        makeOP<op::v1::Multiply>({select_Gather_381, select_Gather_382}, {{"auto_broadcast", "numpy"}});//x_odd_sin
    auto mul_Multiply_383 =
        makeOP<op::v1::Multiply>({select_Gather_384, select_Gather_385}, {{"auto_broadcast", "numpy"}});//x_even_cos
    auto sub_Subtract_389 =
        makeOP<op::v1::Subtract>({mul_Multiply_383, mul_Multiply_386}, {{"auto_broadcast", "numpy"}});

    auto mul_Multiply_391 =
        makeOP<op::v1::Multiply>({select_Gather_381, select_Gather_385}, {{"auto_broadcast", "numpy"}});//x_odd_cos
    auto mul_Multiply_393 =
        makeOP<op::v1::Multiply>({select_Gather_384, select_Gather_382}, {{"auto_broadcast", "numpy"}});//x_even_sin
    auto add_Add_396 = makeOP<op::v1::Add>({mul_Multiply_391, mul_Multiply_393}, {{"auto_broadcast", "numpy"}});
    ...
    auto stack_401 = makeOP<op::v0::Concat>({Unsqueeze_62716, Unsqueeze_62717}, {{"axis", -1}});
    auto flatten_Reshape_421 = makeOP<op::v1::Reshape>({stack_401, {0, 32, 0, 64}}, {{"special_zero", true}});
    auto slice_Slice_363 =
        makeOP<op::v1::StridedSlice>({permute_Transpose, {0, 0, 0, 64}, {0, 0, 0, INT_MAX}, {1, 1, 1, 1}},
                                     {{"begin_mask", {1, 1, 1, 0}},
                                      {"end_mask", {1, 1, 1, 0}},
                                      {"new_axis_mask", {}},
                                      {"shrink_axis_mask", {}},
