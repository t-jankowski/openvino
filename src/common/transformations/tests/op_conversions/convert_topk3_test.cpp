...
TEST_F(TransformationTestsF, ConvertTopK3I32Output0) {
    {
        auto input = std::make_shared<op::v0::Parameter>(element::f32, Shape{15, 20, 3});
        auto k = op::v0::Constant::create(element::i64, Shape{}, {10});
        auto topk = std::make_shared<op::v3::TopK>(input, k, 1, "min", "value", element::i32);
...

    {
        auto input = std::make_shared<op::v0::Parameter>(element::f32, Shape{15, 20, 3});
        auto k = op::v0::Constant::create(element::i64, Shape{}, {10});
        auto topk = std::make_shared<op::v1::TopK>(input, k, 1, "min", "value", element::i32);
        topk->set_friendly_name("topk");
...
TEST_F(TransformationTestsF, ConvertTopK3I64Output1) {
...

    {
        ...
        auto k = op::v0::Constant::create(element::i64, Shape{}, {10});
        auto topk = std::make_shared<op::v1::TopK>(input, k, 1, "min", "value", element::i32);
        auto convert = std::make_shared<op::v0::Convert>(topk->output(1), element::i64);
