...
TEST_F(TransformationTestsF, MarkRopeInputsToKeepInMixedPrecisionTest) {
    ...
    */
    {
        auto input = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ov::Shape{1, 10, 8, 64});
        auto input_a = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ov::Shape{1, 32, 1});
        auto input_b = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ov::Shape{1, 1, 10});
        ...
        auto concat = std::make_shared<ov::op::v0::Concat>(ov::NodeVector{transpose, transpose}, -1);
