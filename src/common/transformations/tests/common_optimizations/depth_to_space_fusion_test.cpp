...
TEST_F(TransformationTestsF, DepthToSpaceFusionDepthFirst) {
    {
        auto input0 = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 128, 720, 480});
        auto shape_reshape_before = op::v0::Constant::create(element::i64, Shape{6}, {1, 32, 2, 2, 720, 480});
        auto permutation = op::v0::Constant::create(element::i64, Shape{6}, {0, 1, 4, 2, 5, 3});
        auto shape_reshape_after = op::v0::Constant::create(element::i64, Shape{4}, {1, 32, 1440, 960});

        auto reshape_before = std::make_shared<op::v1::Reshape>(input0, shape_reshape_before, false);
        auto permute = std::make_shared<op::v1::Transpose>(reshape_before, permutation);
        auto reshape_after = std::make_shared<op::v1::Reshape>(permute, shape_reshape_after, false);
        ...
        auto callback = [](const std::shared_ptr<const Node>& node) -> bool {
            return ov::as_type_ptr<const op::v0::DepthToSpace>(node) != nullptr;
        };
...

    {
        auto input0 = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 128, 720, 480});
        auto depth_to_space =
            std::make_shared<op::v0::DepthToSpace>(input0, op::v0::DepthToSpace::DepthToSpaceMode::DEPTH_FIRST, 2);
...
TEST_F(TransformationTestsF, DepthToSpaceFusionDepthFirstDynamicBatch) {
    {
        ...
        auto reshape_before = std::make_shared<op::v1::Reshape>(input, shape_reshape_before, false);
        auto permute = std::make_shared<op::v1::Transpose>(reshape_before, permutation);
        auto reshape_after = std::make_shared<op::v1::Reshape>(permute, shape_reshape_after, false);
...
TEST_F(TransformationTestsF, DepthToSpaceFusionBlockFirst) {
    {
        auto input0 = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 128, 720, 480});
        auto shape_reshape_before = op::v0::Constant::create(element::i64, Shape{6}, {1, 2, 2, 32, 720, 480});
        auto permutation = op::v0::Constant::create(element::i64, Shape{6}, {0, 3, 4, 1, 5, 2});
        auto shape_reshape_after = op::v0::Constant::create(element::i64, Shape{4}, {1, 32, 1440, 960});
...

    {
        auto input0 = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 128, 720, 480});
        auto depth_to_space =
            std::make_shared<op::v0::DepthToSpace>(input0, op::v0::DepthToSpace::DepthToSpaceMode::BLOCKS_FIRST, 2);
        model_ref = std::make_shared<ov::Model>(NodeVector{depth_to_space}, ParameterVector{input0});
    }
}
...
TEST_F(TransformationTestsF, DepthToSpaceFusionDynamicShape) {
    {
        auto input0 = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 128, 720, 480});
        auto shape_reshape_before = std::make_shared<op::v0::Parameter>(element::i64, Shape{6});
        auto permutation = op::v0::Constant::create(element::i64, Shape{6}, {0, 3, 4, 1, 5, 2});
        auto shape_reshape_after = op::v0::Constant::create(element::i64, Shape{4}, {1, 32, 1440, 960});
...
TEST_F(TransformationTestsF, DepthToSpaceFusionSeveralConsumers) {
    {
        ...
        auto permute = std::make_shared<op::v1::Transpose>(reshape_before, permutation);
        auto reshape_after = std::make_shared<op::v1::Reshape>(permute, shape_reshape_after, false);
        auto result = std::make_shared<op::v0::Result>(reshape_after);

        // additional consumer
        auto additional_consumer = std::make_shared<op::v0::Result>(reshape_before);
