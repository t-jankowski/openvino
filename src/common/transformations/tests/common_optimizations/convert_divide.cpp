...
TEST_F(TransformationTestsF, ConvertDivide) {
    {
        ...
        auto divide_constant = op::v0::Constant::create(element::f32, Shape{1}, {1.5});
        auto divide = std::make_shared<op::v1::Divide>(data, divide_constant);
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{3, 1, 2});
        auto divide_constant = op::v0::Constant::create(element::f32, Shape{1}, {1. / 1.5});
        auto mul = std::make_shared<op::v1::Multiply>(data, divide_constant);
...
TEST_F(TransformationTestsF, ConvertDivideInverse) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{3, 1, 2});
        auto divide_constant = op::v0::Constant::create(element::f32, Shape{1}, {1});
        auto divide = std::make_shared<op::v1::Divide>(divide_constant, data);
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{3, 1, 2});
        auto constant = op::v0::Constant::create(element::f32, Shape{}, {-1.0});
        auto pow = std::make_shared<op::v1::Power>(data, constant);
...
TEST_F(TransformationTestsF, ConvertDivideNegative) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::i32, Shape{3, 1, 2});
        auto divide_constant = op::v0::Constant::create(element::i32, Shape{1}, {2});
        auto divide = std::make_shared<op::v1::Divide>(data, divide_constant);
...
TEST_F(TransformationTestsF, ConvertDivideScalar) {
    {
        auto data1 = std::make_shared<op::v0::Parameter>(element::f32, Shape{});
        auto data2 = std::make_shared<op::v0::Parameter>(element::f32, Shape{});
...

    {
        ...
        auto pow_input = std::make_shared<op::v0::Parameter>(element::f32, Shape{});
        auto pow = std::make_shared<op::v1::Power>(pow_input, op::v0::Constant::create(element::f32, Shape{}, {-1}));
        auto mul = std::make_shared<op::v1::Multiply>(data, pow);
...
TEST_F(TransformationTestsF, ConvertDivideWithConstantPositive) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{});
        auto divide_constant = op::v0::Constant::create(element::f32, Shape{}, {1.5});
        auto divide = std::make_shared<op::v1::Divide>(data, divide_constant);
...
TEST_F(TransformationTestsF, ConvertDivideFP16ShapeOfSubgraphNegative) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f16, Shape{1, 3, 22, 22});
        ...
        auto divide_constant = op::v0::Constant::create(element::f16, Shape{1}, {0.5});
...
TEST_F(TransformationTestsF, ConvertDivide_If) {
    {
        auto data1 = op::v0::Constant::create(element::f16, Shape{1}, {5});
        auto data2 = op::v0::Constant::create(element::f16, Shape{1}, {1});
        auto data = std::make_shared<op::v0::Parameter>(element::f16, Shape{1, 3, 22, 22});
        auto divide = std::make_shared<op::v1::Divide>(data, data2);
        auto convert_after = std::make_shared<op::v0::Convert>(divide, element::i32);
        ...
        auto interpolate = std::make_shared<op::v0::Interpolate>(data, convert_after, interp_attr);
        auto then_op_result = std::make_shared<op::v0::Result>(interpolate);

        auto body_then_function = std::make_shared<ov::Model>(NodeVector{then_op_result}, ParameterVector{data});

        // create else body
        auto input_else = std::make_shared<ov::op::v0::Parameter>(ov::element::f16, ov::Shape{1, 3, 22, 22});
        ...
        // create main graph
        auto input = std::make_shared<ov::op::v0::Parameter>(ov::element::f16, ov::Shape{1, 3, 22, 22});
        ...
        auto if_result = std::make_shared<op::v0::Result>(if_op);
...
TEST_F(TransformationTestsF, ConvertDivideFP16ShapeOfSubgraphNegative2) {
    {
        ...
        auto data2 = std::make_shared<op::v0::Parameter>(element::i32, Shape{2});
        auto add = std::make_shared<op::v1::Add>(data2, convert_after);
...
TEST_F(TransformationTestsF, ConvertDivideFP32ShapeOfSubgraphNegative) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{1, 3, 22, 22});
        auto gather = ov::op::util::node_to_get_shape_value_of_indices_from_shape_source(data, {2, 3});
        auto convert = std::make_shared<op::v0::Convert>(gather, element::f32);
        auto divide_constant = op::v0::Constant::create(element::f32, Shape{1}, {0.5});
        auto divide = std::make_shared<op::v1::Divide>(convert, divide_constant);
        auto convert_after = std::make_shared<op::v0::Convert>(divide, element::i32);
