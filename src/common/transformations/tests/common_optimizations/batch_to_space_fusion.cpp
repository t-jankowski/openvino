...
TEST_F(TransformationTestsF, BatchToSpaceFusionTranspose) {
    {
        ...
        auto depth_to_space =
            std::make_shared<op::v0::DepthToSpace>(trans_before,
                                                   op::v0::DepthToSpace::DepthToSpaceMode::BLOCKS_FIRST,
                                                   2);
        auto slice =
            std::make_shared<op::v1::StridedSlice>(depth_to_space,
                                                   op::v0::Constant::create(element::i64, Shape{4}, {0, 0, 2, 1}),
                                                   op::v0::Constant::create(element::i64, Shape{4}, {2, 1, -1, 2}),
                                                   std::vector<int64_t>{0, 0, 0, 0},
                                                   std::vector<int64_t>{0, 0, 0, 0});
        auto trans_after =
            std::make_shared<op::v1::Transpose>(slice, op::v0::Constant::create(element::i64, Shape{4}, {1, 0, 2, 3}));
...

    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{12, 3, 4, 8});
        auto batch_to_space =
            std::make_shared<op::v1::BatchToSpace>(data,
...
TEST_F(TransformationTestsF, BatchToSpaceFusionReshape) {
    {
        ...
        auto slice =
            std::make_shared<op::v1::StridedSlice>(depth_to_space,
                                                   ...
                                                   std::vector<int64_t>{0, 0, 0, 0});
        auto reshape_after =
            std::make_shared<op::v1::Reshape>(slice,
...
TEST_F(TransformationTestsF, NegativeBatchToSpaceFusionInvalidTransposePerm) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{12, 3, 4, 8});
        auto trans_before =
            std::make_shared<op::v1::Transpose>(data, op::v0::Constant::create(element::i64, Shape{4}, {2, 0, 1, 3}));
        auto depth_to_space =
            std::make_shared<op::v0::DepthToSpace>(trans_before,
                                                   op::v0::DepthToSpace::DepthToSpaceMode::BLOCKS_FIRST,
                                                   2);
...
TEST_F(TransformationTestsF, NegativeBatchToSpaceFusionInvalidMode) {
    {
        ...
        auto depth_to_space =
            std::make_shared<op::v0::DepthToSpace>(trans_before,
                                                   op::v0::DepthToSpace::DepthToSpaceMode::DEPTH_FIRST,
                                                   2);
        auto slice =
            std::make_shared<op::v1::StridedSlice>(depth_to_space,
                                                   op::v0::Constant::create(element::i64, Shape{4}, {0, 0, 2, 1}),
...
TEST_F(TransformationTestsF, NegativeBatchToSpaceFusionInvalidRank) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{16, 3, 4, 8, 8});
        auto trans_before =
        ...
        auto slice =
            std::make_shared<op::v1::StridedSlice>(depth_to_space,
                                                   ...
                                                   std::vector<int64_t>{0, 0, 0, 0, 0});
        auto trans_after =
            std::make_shared<op::v1::Transpose>(slice,
                                                op::v0::Constant::create(element::i64, Shape{5}, {1, 0, 2, 3, 4}));
        model = std::make_shared<Model>(NodeVector{trans_after}, ParameterVector{data});
        manager.register_pass<ov::pass::BatchToSpaceFusion>();
    }
