...
TEST_F(TransformationTestsF, SpaceToBatchFusionTranspose) {
    {
        ...
        auto trans_before =
            std::make_shared<op::v1::Transpose>(data, op::v0::Constant::create(element::i64, Shape{4}, {1, 0, 2, 3}));
        auto pad = std::make_shared<op::v1::Pad>(trans_before,
                                                 ...
                                                 op::PadMode::CONSTANT);
        auto space_to_depth =
            std::make_shared<op::v0::SpaceToDepth>(pad, op::v0::SpaceToDepth::SpaceToDepthMode::BLOCKS_FIRST, 2);
        auto trans_after =
            std::make_shared<op::v1::Transpose>(space_to_depth,
...

    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{12, 3, 4, 8});
        auto space_to_batch =
            std::make_shared<op::v1::SpaceToBatch>(data,
...
TEST_F(TransformationTestsF, SpaceToBatchFusionTransposeNegativePads) {
    {
        ...
        auto pad = std::make_shared<op::v12::Pad>(trans_before,
                                                  ...
                                                  op::PadMode::CONSTANT);
        auto space_to_depth =
            std::make_shared<op::v0::SpaceToDepth>(pad, op::v0::SpaceToDepth::SpaceToDepthMode::BLOCKS_FIRST, 4);
        auto trans_after =
            std::make_shared<op::v1::Transpose>(space_to_depth,
                                                op::v0::Constant::create(element::i64, Shape{4}, {1, 0, 2, 3}));
        model = std::make_shared<Model>(NodeVector{trans_after}, ParameterVector{data});
...
TEST_F(TransformationTestsF, SpaceToBatchFusionReshape) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{12, 3, 4, 8});
        auto reshape_before =
            std::make_shared<op::v1::Reshape>(data,
                                              op::v0::Constant::create(element::i64, Shape{4}, {3, 12, 4, 8}),
                                              false);
        auto pad = std::make_shared<op::v1::Pad>(reshape_before,
                                                 op::v0::Constant::create(element::i64, Shape{4}, {1, 1, 1, 1}),
                                                 op::v0::Constant::create(element::i64, Shape{4}, {2, 2, 3, 3}),
                                                 op::v0::Constant::create(element::f32, Shape{}, {0}),
                                                 op::PadMode::CONSTANT);
...
TEST_F(TransformationTestsF, NegativeSpaceToBatchFusionInvalidTransposePerm) {
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, Shape{12, 3, 4, 8});
        auto trans_before =
            std::make_shared<op::v1::Transpose>(data, op::v0::Constant::create(element::i64, Shape{4}, {3, 0, 2, 1}));
        auto pad = std::make_shared<op::v1::Pad>(trans_before,
                                                 op::v0::Constant::create(element::i64, Shape{4}, {1, 1, 1, 1}),
...
TEST_F(TransformationTestsF, NegativeSpaceToBatchFusionInvalidMode) {
    {
        ...
        auto pad = std::make_shared<op::v1::Pad>(trans_before,
                                                 ...
                                                 op::PadMode::CONSTANT);
        auto space_to_depth =
            std::make_shared<op::v0::SpaceToDepth>(pad, op::v0::SpaceToDepth::SpaceToDepthMode::DEPTH_FIRST, 2);
        auto trans_after =
            std::make_shared<op::v1::Transpose>(space_to_depth,
                                                op::v0::Constant::create(element::i64, Shape{4}, {1, 0, 2, 3}));
        model = std::make_shared<Model>(NodeVector{trans_after}, ParameterVector{data});
...
TEST_F(TransformationTestsF, NegativeSpaceToBatchFusionInvalidRank) {
    {
        ...
        auto trans_before =
            std::make_shared<op::v1::Transpose>(data,
