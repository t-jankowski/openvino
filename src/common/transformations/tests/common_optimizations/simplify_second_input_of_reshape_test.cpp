...
auto gather = [](const std::shared_ptr<Node> input, std::vector<int64_t> indices) -> Output<Node> {
    std::shared_ptr<Node> indices_node = op::v0::Constant::create(element::i64, {indices.size()}, indices);
    std::shared_ptr<Node> axis_node = op::v0::Constant::create(element::i64, {}, {0});
    return std::make_shared<op::v7::Gather>(input, indices_node, axis_node);
};

auto fake_quantize = [](const std::shared_ptr<Node> input) -> Output<Node> {
    auto il = op::v0::Constant::create(element::f32, Shape{}, {0.f});
    auto ih = op::v0::Constant::create(element::f32, Shape{}, {25.5f});
    auto ol = op::v0::Constant::create(element::f32, Shape{}, {0.f});
    auto oh = op::v0::Constant::create(element::f32, Shape{}, {25.5f});
    return std::make_shared<op::v0::FakeQuantize>(input, il, ih, ol, oh, 256);
};
}  // namespace
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest1) {
    PartialShape data_shape{1, 128, 12, 64};
    {
        ...
        auto constant = op::v0::Constant::create(element::i64, Shape{1}, {768});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{gather_op, constant}, 0);
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, data_shape);
        auto reshape_pattern = op::v0::Constant::create(element::i64, Shape{3}, {0, 0, 768});
        auto reshape = std::make_shared<op::v1::Reshape>(data, reshape_pattern, true);
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest2) {
    PartialShape data_shape{1, 128, 12, 64};
    {
        ...
        auto reshape = std::make_shared<op::v1::Reshape>(fq, concat, true);
        model = std::make_shared<Model>(NodeVector{reshape}, ParameterVector{data});
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest3) {
    PartialShape data_shape{1, 128, 768};
    {
        ...
        auto shape_of = std::make_shared<op::v3::ShapeOf>(data);
        auto gather_op = gather(shape_of, std::vector<int64_t>{0, 1});
        auto constant_1 = op::v0::Constant::create(element::i64, Shape{1}, {12});
        auto constant_2 = op::v0::Constant::create(element::i64, Shape{1}, {64});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{gather_op, constant_1, constant_2}, 0);
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, data_shape);
        auto reshape_pattern = op::v0::Constant::create(element::i64, Shape{4}, {0, 0, 12, 64});
        auto reshape = std::make_shared<op::v1::Reshape>(data, reshape_pattern, true);
        model_ref = std::make_shared<Model>(NodeVector{reshape}, ParameterVector{data});
    }
    comparator.enable(FunctionsComparator::CONST_VALUES);
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest5) {
    PartialShape data_shape = PartialShape::dynamic(3);
    {
        ...
        auto shape_of = std::make_shared<op::v3::ShapeOf>(data);
        auto gather_op = gather(shape_of, std::vector<int64_t>{0, 1});
        auto constant = op::v0::Constant::create(element::i64, Shape{1}, {-1});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{gather_op, constant}, 0);
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, data_shape);
        auto reshape_pattern = op::v0::Constant::create(element::i64, Shape{3}, {0, 0, -1});
        auto reshape = std::make_shared<op::v1::Reshape>(data, reshape_pattern, true);
        model_ref = std::make_shared<Model>(NodeVector{reshape}, ParameterVector{data});
    }
    comparator.enable(FunctionsComparator::CONST_VALUES);
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest7) {
    PartialShape data_shape{1, 128, 12, 64};
    {
        ...
        auto constant_1 = op::v0::Constant::create(element::i64, Shape{1}, {64});
        auto constant_2 = op::v0::Constant::create(element::i64, Shape{1}, {2});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{constant_1, constant_2, gather_op}, 0);
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, data_shape);
        auto reshape_pattern = op::v0::Constant::create(element::i64, Shape{4}, {64, 2, 0, 0});
        auto reshape = std::make_shared<op::v1::Reshape>(data, reshape_pattern, true);
        model_ref = std::make_shared<Model>(NodeVector{reshape}, ParameterVector{data});
    }
    comparator.enable(FunctionsComparator::CONST_VALUES);
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest8) {
    PartialShape data_shape{1, 128, 12, 64};
    {
        ...
        auto constant_1 = op::v0::Constant::create(element::i64, Shape{1}, {64});
        auto constant_2 = op::v0::Constant::create(element::i64, Shape{1}, {2});
        auto constant_3 = op::v0::Constant::create(element::i64, Shape{1}, {64});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{constant_1, constant_2, gather_op, constant_3}, 0);
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, data_shape);
        auto reshape_pattern = op::v0::Constant::create(element::i64, Shape{4}, {64, 2, 0, 64});
        auto reshape = std::make_shared<op::v1::Reshape>(data, reshape_pattern, true);
        model_ref = std::make_shared<Model>(NodeVector{reshape}, ParameterVector{data});
    }
    comparator.enable(FunctionsComparator::CONST_VALUES);
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest10) {
    PartialShape data_shape{1, 128, 12, 64};
    {
        ...
        auto shape_of_1 = std::make_shared<op::v3::ShapeOf>(data);
        auto shape_of_2 = std::make_shared<op::v3::ShapeOf>(data);
        ...
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{gather_op_1, gather_op_2, gather_op_3}, 0);
    ...
    }
    {
        ...
        auto shape_of = std::make_shared<op::v3::ShapeOf>(data);
        auto constant = op::v0::Constant::create(element::i64, Shape{2}, {0, 0});
        auto gather_op_2 = gather(shape_of, std::vector<int64_t>{3});
        auto gather_op_3 = gather(shape_of, std::vector<int64_t>{2});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{constant, gather_op_2, gather_op_3}, 0);
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest11) {
    PartialShape data_shape{1, 128, 12, 64};
    {
        ...
        auto concat_input_1 = op::v0::Constant::create(element::i64, {1}, {64});
        auto concat_input_2 = gather(shape_of_2, std::vector<int64_t>{2});
        auto concat_input_3 = op::v0::Constant::create(element::i64, {1}, {128});
        auto concat = std::make_shared<op::v0::Concat>(
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, data_shape);
        auto constant = op::v0::Constant::create(element::i64, Shape{4}, {0, 64, 0, 128});
        auto reshape = std::make_shared<op::v1::Reshape>(data, constant, true);
        model_ref = std::make_shared<Model>(NodeVector{reshape}, ParameterVector{data});
    }
    comparator.enable(FunctionsComparator::CONST_VALUES);
}
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest12) {
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, data_shape);
        auto gelu = std::make_shared<op::v7::Gelu>(data);
        ...
        auto reshape = std::make_shared<op::v1::Reshape>(gelu, concat, true);
        model = std::make_shared<Model>(NodeVector{reshape}, ParameterVector{data});
    ...
    }
    {
        ...
        auto gelu = std::make_shared<op::v7::Gelu>(data);
        auto reshape_pattern = op::v0::Constant::create(element::i64, Shape{4}, {0, 0, 12, 64});
        auto reshape = std::make_shared<op::v1::Reshape>(gelu, reshape_pattern, true);
        model_ref = std::make_shared<Model>(NodeVector{reshape}, ParameterVector{data});
    }
    comparator.enable(FunctionsComparator::CONST_VALUES);
}
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest13) {
    PartialShape data_shape{1, 128, 12, 64};
    {
        ...
        auto shape_of = std::make_shared<op::v3::ShapeOf>(data, element::i32);
        auto gather_op = gather(shape_of, std::vector<int64_t>{0, 1});
        auto constant = op::v0::Constant::create(element::i32, Shape{1}, {768});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{gather_op, constant}, 0);
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, data_shape);
        auto reshape_pattern = op::v0::Constant::create(element::i32, Shape{3}, {0, 0, 768});
        auto reshape = std::make_shared<op::v1::Reshape>(data, reshape_pattern, true);
        model_ref = std::make_shared<Model>(NodeVector{reshape}, ParameterVector{data});
    }
    comparator.enable(FunctionsComparator::CONST_VALUES);
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest15) {
    PartialShape data_shape{1, 128, 768};
    {
        ...
        auto shape_of = std::make_shared<op::v3::ShapeOf>(data);
        auto gather_op = gather(shape_of, std::vector<int64_t>{0, 1});
        auto constant = op::v0::Constant::create(element::i64, Shape{2}, {12, 64});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{gather_op, constant}, 0);
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest16) {
    PartialShape data_shape{1, 128, 12, 64};
    {
        ...
        auto constant = op::v0::Constant::create(element::i64, Shape{1}, {768});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{gather_op_1, gather_op_2, constant}, 0);
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest17) {
    ...
    {
        auto data_1 = std::make_shared<op::v0::Parameter>(element::f32, data_shape);
        auto data_2 = std::make_shared<op::v0::Parameter>(element::f32, data_shape);

        auto shape_of_1 = std::make_shared<op::v3::ShapeOf>(data_1);
        auto gather_op_1 = gather(shape_of_1, std::vector<int64_t>{0});

        auto constant_1 = op::v0::Constant::create(element::i64, Shape{1}, {4});
        auto constant_2 = op::v0::Constant::create(element::i64, Shape{1}, {64});

        auto shape_of_2 = std::make_shared<op::v3::ShapeOf>(data_2);
        auto gather_op_2 = gather(shape_of_2, std::vector<int64_t>{2});
        auto concat =
            std::make_shared<op::v0::Concat>(OutputVector{gather_op_1, constant_1, constant_2, gather_op_2}, 0);

        auto reshape = std::make_shared<op::v1::Reshape>(data_2, concat, true);
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest18) {
    ...
    PartialShape data_shape{2, 6, 6};
    {
        ...
        auto constant = op::v0::Constant::create(element::i64, Shape{2}, {2, 3});
        auto gather_2 = gather(shape_of, std::vector<int64_t>{2});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{gather_1, constant, gather_2}, 0);
...

    {
        ...
        auto shape_of = std::make_shared<op::v3::ShapeOf>(data);
        auto gather_1 = op::v0::Constant::create(element::i64, Shape{1}, {0});
        auto constant = op::v0::Constant::create(element::i64, Shape{2}, {2, 3});
        auto gather_2 = gather(shape_of, std::vector<int64_t>{2});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{gather_1, constant, gather_2}, 0);
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest19) {
    ...
    PartialShape data_shape{2, 4, 2, 6};
    {
        ...
        auto shape_of = std::make_shared<op::v3::ShapeOf>(data);
        auto gather_1 = gather(shape_of, {0});
        auto constant = op::v0::Constant::create(element::i64, Shape{1}, {8});
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest20) {
    ...
    {
        auto data = std::make_shared<op::v0::Parameter>(element::f32, data_shape);
        auto data_copy = std::make_shared<op::v0::Parameter>(element::f32, data_shape);

        auto shape_of = std::make_shared<op::v3::ShapeOf>(data);
        auto shape_of_copy = std::make_shared<op::v3::ShapeOf>(data_copy);

        auto gather_1 = gather(shape_of, {0});
        auto constant_1 = op::v0::Constant::create(element::i64, Shape{1}, {2});
        auto gather_2 = gather(shape_of_copy, {2, 3});
        auto constant_2 = op::v0::Constant::create(element::i64, Shape{1}, {2});
        auto gather_3 = gather(shape_of, {4});
        auto concat =
            std::make_shared<op::v0::Concat>(OutputVector{gather_1, constant_1, gather_2, constant_2, gather_3}, 0);
...
TEST_F(TransformationTestsF, SimplifySecondInputOfReshapeTest21) {
    PartialShape data_shape{1, 128, 12, 64};
    {
        ...
        auto gather_op = gather(shape_of, std::vector<int64_t>{0, 1});
        auto constant = op::v0::Constant::create(element::i64, Shape{1}, {768});
        auto concat = std::make_shared<op::v0::Concat>(OutputVector{gather_op, constant}, -1);
