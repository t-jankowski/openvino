...
TEST_F(TransformationTestsF, BinarizeWeightsActivationsOutputLowZero) {
    {
        ...
        auto act_out_high = op::v0::Constant::create(element::f32, Shape{1}, {0.7f});
        auto act_fq =
            std::make_shared<op::v0::FakeQuantize>(data, act_in_low, act_in_high, act_out_low, act_out_high, 2);
        auto weights = op::v0::Constant::create(element::f32, Shape{1, 3, 1, 1}, {-1, 0, 2});
        auto weights_in_low = op::v0::Constant::create(element::f32, Shape{1}, {-1.0f});
        auto weights_in_high = op::v0::Constant::create(element::f32, Shape{1}, {2.0f});
        auto weights_out_low = op::v0::Constant::create(element::f32, Shape{1}, {-0.2f});
        auto weights_out_high = op::v0::Constant::create(element::f32, Shape{1}, {0.2f});
        auto weights_fq = std::make_shared<op::v0::FakeQuantize>(weights,
                                                                 weights_in_low,
                                                                 weights_in_high,
                                                                 weights_out_low,
                                                                 weights_out_high,
                                                                 2);
        auto conv = std::make_shared<op::v1::Convolution>(act_fq,
                                                          weights_fq,
                                                          Strides{1, 1},
                                                          CoordinateDiff{0, 0},
                                                          CoordinateDiff{0, 0},
...

    {
        ...
        auto conv = std::make_shared<op::v1::Convolution>(act_fq,
                                                          ...
                                                          Strides{1, 1});
        auto mul =
            std::make_shared<op::v1::Multiply>(conv, op::v0::Constant::create(element::f32, Shape{1, 1, 1}, {0.7f}));
        auto mul2 =
            std::make_shared<op::v1::Multiply>(mul, op::v0::Constant::create(element::f32, Shape{1, 1, 1}, {0.2f}));
...
TEST_F(TransformationTestsF, BinarizeWeightsActivationsOutputLowNegative) {
    {
        ...
        auto act_in_low = op::v0::Constant::create(element::f32, Shape{1}, {1.0f});
        auto act_in_high = op::v0::Constant::create(element::f32, Shape{1}, {3.0f});
        auto act_out_low = op::v0::Constant::create(element::f32, Shape{1}, {-0.7f});
        auto act_out_high = op::v0::Constant::create(element::f32, Shape{1}, {0.7f});
        auto act_fq =
            std::make_shared<op::v0::FakeQuantize>(data, act_in_low, act_in_high, act_out_low, act_out_high, 2);
        auto weights = op::v0::Constant::create(element::f32, Shape{1, 3, 1, 1}, {-1, 0, 2});
...
TEST_F(TransformationTestsF, NegativeBinarizeWeightsInvalidLevels) {
    {
        ...
        auto act_out_high = op::v0::Constant::create(element::f32, Shape{1}, {0.7f});
        auto act_fq =
            std::make_shared<op::v0::FakeQuantize>(data, act_in_low, act_in_high, act_out_low, act_out_high, 3);
        auto weights = op::v0::Constant::create(element::f32, Shape{1, 3, 1, 1}, {-1, 0, 2});
        auto weights_in_low = op::v0::Constant::create(element::f32, Shape{1}, {-1.0f});
        auto weights_in_high = op::v0::Constant::create(element::f32, Shape{1}, {2.0f});
        auto weights_out_low = op::v0::Constant::create(element::f32, Shape{1}, {-0.2f});
...
TEST_F(TransformationTestsF, NegativeBinarizeWeightsInvalidActivationsOutputLowHigh) {
    {
        ...
        auto act_in_low = op::v0::Constant::create(element::f32, Shape{1}, {1.0f});
        auto act_in_high = op::v0::Constant::create(element::f32, Shape{1}, {3.0f});
        auto act_out_low = op::v0::Constant::create(element::f32, Shape{1}, {0.2f});
        auto act_out_high = op::v0::Constant::create(element::f32, Shape{1}, {0.7f});
        auto act_fq =
            std::make_shared<op::v0::FakeQuantize>(data, act_in_low, act_in_high, act_out_low, act_out_high, 2);
        auto weights = op::v0::Constant::create(element::f32, Shape{1, 3, 1, 1}, {-1, 0, 2});
...
TEST_F(TransformationTestsF, NegativeBinarizeWeightsInvalidOutputLowHigh) {
    {
        ...
        auto weights_in_low = op::v0::Constant::create(element::f32, Shape{1}, {-1.0f});
        auto weights_in_high = op::v0::Constant::create(element::f32, Shape{1}, {2.0f});
        auto weights_out_low = op::v0::Constant::create(element::f32, Shape{1}, {0.0f});
        auto weights_out_high = op::v0::Constant::create(element::f32, Shape{1}, {0.2f});
        auto weights_fq = std::make_shared<op::v0::FakeQuantize>(weights,
                                                                 weights_in_low,
                                                                 weights_in_high,
