...
TEST_F(TransformationTestsF, StridesOptimization4) {
    {
        ...
        auto conv_1 = std::make_shared<ov::op::v1::Convolution>(data,
                                                                ...
                                                                CoordinateDiff{},
                                                                Strides{});
        auto relu_1 = std::make_shared<op::v0::Relu>(conv_1);
        auto weights_2 = ov::op::v0::Constant::create(element::f32, Shape{3, 3, 3, 3}, {128});
        auto conv_2 = std::make_shared<ov::op::v1::Convolution>(data,
                                                                ...
                                                                CoordinateDiff{},
                                                                Strides{});
        auto relu_2 = std::make_shared<op::v0::Relu>(conv_2);
        auto add = std::make_shared<op::v1::Add>(relu_1, relu_2);
...
TEST_F(TransformationTestsF, StridesOptimization5) {
    {
        ...
        auto conv_1 = std::make_shared<ov::op::v1::Convolution>(data,
                                                                ...
                                                                Strides{});
        auto relu_1 = std::make_shared<op::v0::Relu>(conv_1);
        auto relu_2 = std::make_shared<op::v0::Relu>(data);
        auto add = std::make_shared<op::v1::Add>(relu_1, relu_2);
        auto weights_2 = ov::op::v0::Constant::create(element::f32, Shape{3, 3, 1, 1}, {128});
    ...
    }
    {
        ...
        auto conv_1 = std::make_shared<ov::op::v1::Convolution>(data,
                                                                ...
                                                                Strides{});
        auto relu_1 = std::make_shared<op::v0::Relu>(conv_1);
        auto pool = std::make_shared<op::v1::MaxPool>(data, Strides{2, 2}, Shape{0, 0}, Shape{0, 0}, Shape{1, 1});
        auto relu_2 = std::make_shared<op::v0::Relu>(pool);
        auto add = std::make_shared<op::v1::Add>(relu_1, relu_2);
        auto weights_2 = ov::op::v0::Constant::create(element::f32, Shape{3, 3, 1, 1}, {128});
        auto conv_2 = std::make_shared<ov::op::v1::Convolution>(add,
                                                                weights_2,
...
TEST_F(TransformationTestsF, StridesOptimization7) {
    ...
    }
    {
        ...
        auto conv_3 = std::make_shared<ov::op::v1::Convolution>(conv_2,
                                                                ...
                                                                CoordinateDiff{},
                                                                Strides{});
        auto pool = std::make_shared<op::v1::MaxPool>(conv_1, Strides{2, 2}, Shape{0, 0}, Shape{0, 0}, Shape{1, 1});
        auto relu = std::make_shared<op::v0::Relu>(pool);
        auto weights_4 = ov::op::v0::Constant::create(element::f32, Shape{3, 3, 1, 1}, {128});
        auto conv_4 = std::make_shared<ov::op::v1::Convolution>(relu,
                                                                weights_4,
                                                                Strides{1, 1},
...
TEST_F(TransformationTestsF, StridesOptimization8) {
    {
        ...
        auto constant =
            op::v0::Constant::create(element::f32, const_shape, std::vector<float>(shape_size(const_shape), 1));
        auto add = std::make_shared<op::v1::Add>(relu_1, constant);
        auto weights_2 = ov::op::v0::Constant::create(element::f32, Shape{3, 3, 1, 1}, {128});
        auto conv_2 = std::make_shared<ov::op::v1::Convolution>(add,
                                                                weights_2,
                                                                Strides{2, 2},
        ...
        auto add_2 = std::make_shared<op::v1::Add>(conv_2, data_2);
        auto weights_3 = ov::op::v0::Constant::create(element::f32, Shape{3, 3, 1, 1}, {128});
    ...
    }
    {
        ...
        auto data_2 = std::make_shared<ov::op::v0::Parameter>(element::f32, Shape{3, 112, 112});
        auto reshape =
            std::make_shared<op::v1::Reshape>(data_2,
                                              op::v0::Constant::create(element::i64, Shape{4}, {1, 3, 112, 112}),
                                              false);
        auto pool_2 = std::make_shared<op::v1::MaxPool>(reshape, Strides{2, 2}, Shape{0, 0}, Shape{0, 0}, Shape{1, 1});
        auto squeeze = std::make_shared<op::v0::Squeeze>(pool_2, op::v0::Constant::create(element::u64, Shape{1}, {0}));
        auto add_2 = std::make_shared<op::v1::Add>(conv_2, squeeze);
        auto weights_3 = ov::op::v0::Constant::create(element::f32, Shape{3, 3, 1, 1}, {128});
        auto conv_3 = std::make_shared<ov::op::v1::Convolution>(add_2,
                                                                weights_3,
                                                                Strides{1, 1},
...
TEST_F(TransformationTestsF, StridesOptimization9) {
    {
        ...
        auto add = std::make_shared<op::v1::Add>(data_2, add_const);
        auto add_2_const = ov::op::v0::Constant::create(element::f32, Shape{224}, {128});
        auto add_2 = std::make_shared<op::v1::Add>(add, add_2_const);

        auto add_3 = std::make_shared<op::v1::Add>(conv_1, add_2);
        auto weights_2 = ov::op::v0::Constant::create(element::f32, Shape{3, 3, 1, 1}, {128});
        ...
        auto add_4 = std::make_shared<op::v1::Add>(data_3, add_4_const);
        auto add_5_const = ov::op::v0::Constant::create(element::f32, Shape{1}, {128});
        auto add_5 = std::make_shared<op::v1::Add>(add_4, add_5_const);
        auto add_6 = std::make_shared<op::v1::Add>(conv_2, add_5);
        auto weights_3 = ov::op::v0::Constant::create(element::f32, Shape{3, 3, 1, 1}, {128});
    ...
    }
    {
        ...
        auto reshape =
            std::make_shared<op::v1::Reshape>(data_2,
                                              op::v0::Constant::create(element::i64, Shape{4}, {1, 1, 1, 224}),
                                              false);
        auto pool = std::make_shared<op::v1::MaxPool>(reshape, Strides{4, 4}, Shape{0, 0}, Shape{0, 0}, Shape{1, 1});
        auto squeeze =
            std::make_shared<op::v0::Squeeze>(pool, op::v0::Constant::create(element::u64, Shape{3}, {0, 1, 2}));
        auto add_const = ov::op::v0::Constant::create(element::f32, Shape{56}, {128});
        auto add = std::make_shared<op::v1::Add>(squeeze, add_const);
        ...
        auto reshape_2 = std::make_shared<op::v1::Reshape>(data_3, new_shape, false);
        auto pool_2 =
            std::make_shared<op::v1::MaxPool>(reshape_2, Strides{2, 2}, Shape{0, 0}, Shape{0, 0}, Shape{1, 1});
        auto squeeze_2 =
            std::make_shared<op::v0::Squeeze>(pool_2, op::v0::Constant::create(element::u64, Shape{4}, {0, 1, 2, 3}));
        auto add_4_const = ov::op::v0::Constant::create(element::f32, Shape{}, {128});
        auto add_4 = std::make_shared<op::v1::Add>(squeeze_2, add_4_const);
        auto add_5_const = ov::op::v0::Constant::create(element::f32, Shape{1}, {128});
        auto add_5 = std::make_shared<op::v1::Add>(add_4, add_5_const);
        auto add_6 = std::make_shared<op::v1::Add>(conv_2, add_5);
        auto weights_3 = ov::op::v0::Constant::create(element::f32, Shape{3, 3, 1, 1}, {128});
