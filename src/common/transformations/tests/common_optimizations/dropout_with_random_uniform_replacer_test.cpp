...
TEST_F(TransformationTestsF, DropoutWithRandomUniformReplacerCase1) {
    {
        ...
        auto add_const = op::v0::Constant::create(element::f32, Shape{}, {30.0});
        auto add = std::make_shared<op::v1::Add>(ru, add_const);
        auto floor = std::make_shared<op::v0::Floor>(add);
    ...
    {
        auto input = std::make_shared<op::v0::Parameter>(element::i32, Shape{3});
        auto broadcast_const = op::v0::Constant::create(element::f32, Shape{}, {0.5});
        auto broadcast = std::make_shared<op::v3::Broadcast>(broadcast_const, input);

        auto add_const = op::v0::Constant::create(element::f32, Shape{}, {30.0});
        auto add = std::make_shared<op::v1::Add>(broadcast, add_const);
        auto floor = std::make_shared<op::v0::Floor>(add);
...
TEST_F(TransformationTestsF, DropoutWithRandomUniformReplacerCase2) {
    {
        auto input = std::make_shared<op::v0::Parameter>(element::i32, Shape{3});
        auto min_const = op::v0::Constant::create(element::f16, Shape{}, {0.0});
        auto max_const = op::v0::Constant::create(element::f16, Shape{}, {1.0});
        auto ru = std::make_shared<op::v8::RandomUniform>(input, min_const, max_const, element::f16, 100, 200);
        auto add_const = op::v0::Constant::create(element::f16, Shape{}, {1.0});
        auto add = std::make_shared<op::v1::Add>(ru, add_const);
        auto floor = std::make_shared<op::v0::Floor>(add);
    ...
    {
        auto input = std::make_shared<op::v0::Parameter>(element::i32, Shape{3});
        auto broadcast_const = op::v0::Constant::create(element::f16, Shape{}, {0.5});
        auto broadcast = std::make_shared<op::v3::Broadcast>(broadcast_const, input);
...
TEST_F(TransformationTestsF, DropoutWithRandomUniformReplacerWithConvert) {
    {
        ...
        auto max_const = op::v0::Constant::create(element::f32, Shape{}, {1.0});
        auto ru = std::make_shared<op::v8::RandomUniform>(input, min_const, max_const, element::f32, 100, 200);
        auto convert = std::make_shared<op::v0::Convert>(ru, element::f16);
        auto add_const = op::v0::Constant::create(element::f16, Shape{}, {1.0});
        auto add = std::make_shared<op::v1::Add>(convert, add_const);
        auto floor = std::make_shared<op::v0::Floor>(add);
...

    {
        ...
        auto broadcast_const = op::v0::Constant::create(element::f32, Shape{}, {0.5});
        auto broadcast = std::make_shared<op::v3::Broadcast>(broadcast_const, input);
        auto convert = std::make_shared<op::v0::Convert>(broadcast, element::f16);
...
TEST_F(TransformationTestsF, DropoutWithRandomUniformReplacerAddConstNegative) {
    {
        ...
        auto max_const = op::v0::Constant::create(element::f32, Shape{}, {1.0});
        auto ru = std::make_shared<op::v8::RandomUniform>(input, min_const, max_const, element::f32, 100, 200);
        auto add_const = op::v0::Constant::create(element::f32, Shape{}, {0.5});
        auto add = std::make_shared<op::v1::Add>(ru, add_const);
        auto floor = std::make_shared<op::v0::Floor>(add);
...
TEST_F(TransformationTestsF, DropoutWithRandomUniformReplacerNonFloatRUNegative) {
    {
        ...
        auto add_const = op::v0::Constant::create(element::i32, Shape{}, {10});
        auto add = std::make_shared<op::v1::Add>(ru, add_const);
        auto floor = std::make_shared<op::v0::Floor>(add);
...
TEST_F(TransformationTestsF, DropoutWithRandomUniformReplacerInvalidMinNegative) {
    {
        auto input = std::make_shared<op::v0::Parameter>(element::i32, Shape{3});
        auto min_const = op::v0::Constant::create(element::f32, Shape{}, {-2.0});
        auto max_const = op::v0::Constant::create(element::f32, Shape{}, {1.0});
        auto ru = std::make_shared<op::v8::RandomUniform>(input, min_const, max_const, element::f32, 100, 200);
        auto add_const = op::v0::Constant::create(element::f32, Shape{}, {1.0});
        auto add = std::make_shared<op::v1::Add>(ru, add_const);
        auto floor = std::make_shared<op::v0::Floor>(add);
...
TEST_F(TransformationTestsF, DropoutWithRandomUniformReplacerInvalidAddConstRankNegative) {
    {
        ...
        auto max_const = op::v0::Constant::create(element::f32, Shape{}, {1.0});
        auto ru = std::make_shared<op::v8::RandomUniform>(input, min_const, max_const, element::f32, 100, 200);
        auto add_const = op::v0::Constant::create(element::f32, Shape{3}, {1.0, 2.0, 3.0});
        auto add = std::make_shared<op::v1::Add>(ru, add_const);
        auto floor = std::make_shared<op::v0::Floor>(add);
