...
TEST_F(TransformationTestsF, SwishFusionWithBeta) {
    {
        ...
        auto beta = std::make_shared<op::v0::Parameter>(element::f32, Shape{});
        auto mul = std::make_shared<op::v1::Multiply>(input, beta);
        auto neg = std::make_shared<op::v0::Negative>(mul);
        auto exp = std::make_shared<op::v0::Exp>(neg);
        auto constant = op::v0::Constant::create(element::f32, Shape{1}, {1.0});
        auto add = std::make_shared<op::v1::Add>(exp, constant);
...

    {
        auto input = std::make_shared<op::v0::Parameter>(element::f32, PartialShape::dynamic(1));
        auto beta = std::make_shared<op::v0::Parameter>(element::f32, Shape{});
        auto swish = std::make_shared<op::v4::Swish>(input, beta);
...
TEST_F(TransformationTestsF, SwishFusionWithoutBeta) {
    {
        ...
        auto exp = std::make_shared<op::v0::Exp>(neg);
        auto constant = op::v0::Constant::create(element::f16, Shape{}, {1.0});
        auto add = std::make_shared<op::v1::Add>(exp, constant);
        auto div = std::make_shared<op::v1::Divide>(input, add);
    ...
    {
        auto input = std::make_shared<op::v0::Parameter>(element::f16, PartialShape::dynamic(1));
        auto swish = std::make_shared<op::v4::Swish>(input);
...
TEST_F(TransformationTestsF, SwishFusionWithoutBetaNonOneAddConstant) {
    {
        ...
        auto neg = std::make_shared<op::v0::Negative>(input);
        auto exp = std::make_shared<op::v0::Exp>(neg);
        auto constant = op::v0::Constant::create(element::f16, Shape{}, {1.1});
        auto add = std::make_shared<op::v1::Add>(exp, constant);
        auto div = std::make_shared<op::v1::Divide>(input, add);
...
TEST_F(TransformationTestsF, SwishFusionWithSigmoid) {
    {
        auto input = std::make_shared<op::v0::Parameter>(element::f16, PartialShape::dynamic(1));
        auto sig = std::make_shared<op::v0::Sigmoid>(input);
        auto mul = std::make_shared<op::v1::Multiply>(input, sig);
...
TEST_F(TransformationTestsF, SwishFusionWithSigmoidWithBeta) {
    {
        auto input = std::make_shared<op::v0::Parameter>(element::f16, PartialShape::dynamic(1));
        auto beta = std::make_shared<op::v0::Parameter>(element::f16, Shape{});
        auto mul_beta = std::make_shared<op::v1::Multiply>(input, beta);
        auto sig = std::make_shared<op::v0::Sigmoid>(mul_beta);
        auto mul = std::make_shared<op::v1::Multiply>(input, sig);
...
TEST_F(TransformationTestsF, SwishFusionWithSigmoidWithBetaConstant) {
    ...
    {
        auto input = std::make_shared<op::v0::Parameter>(element::f16, PartialShape::dynamic(1));
        auto beta = op::v0::Constant::create(element::f16, Shape{3}, {2.0, 2.0, 2.0});
        auto mul_beta = std::make_shared<op::v1::Multiply>(input, beta);
        auto sig = std::make_shared<op::v0::Sigmoid>(mul_beta);
        auto mul = std::make_shared<op::v1::Multiply>(input, sig);
    ...
    {
        auto input = std::make_shared<op::v0::Parameter>(element::f16, PartialShape::dynamic(1));
        auto beta = op::v0::Constant::create(element::f16, Shape{}, {2.0});
        auto swish = std::make_shared<op::v4::Swish>(input, beta);
