...
TEST_F(TransformationTestsF, WrapInterpolateIntoTransposes4DScales) {
    ...
    Shape input_shape{1, 100, 120, 150};
    {
        ...
        auto sizes_node = op::v0::Constant::create(element::i64, Shape{2}, {50, 60});
        auto scales_node = op::v0::Constant::create(element::f32, Shape{2}, {0.5, 0.5});
        auto axis_node = op::v0::Constant::create(element::i64, {2}, std::vector<int64_t>{1, 2});
    ...
    }
    {
        ...
        auto sizes_node = op::v0::Constant::create(element::i64, Shape{2}, {50, 60});
        auto scales_node = op::v0::Constant::create(element::f32, Shape{2}, {0.5, 0.5});
        auto axis_node = op::v0::Constant::create(element::i64, {2}, std::vector<int64_t>{2, 3});

        auto first_transpose_perm = op::v0::Constant::create(element::i64, Shape{4}, {0, 3, 1, 2});
        auto last_transpose_perm = op::v0::Constant::create(element::i64, Shape{4}, {0, 2, 3, 1});

        auto first_transpose = std::make_shared<op::v1::Transpose>(input, first_transpose_perm);
        auto interpolate =
            std::make_shared<op::v4::Interpolate>(first_transpose, sizes_node, scales_node, axis_node, attrs);
        auto last_transpose = std::make_shared<op::v1::Transpose>(interpolate, last_transpose_perm);
...
TEST_F(TransformationTestsF, WrapInterpolateIntoTransposes5DScales) {
    ...
    {
        auto input = std::make_shared<op::v0::Parameter>(element::f32, input_shape);
        auto sizes_node = op::v0::Constant::create(element::i64, Shape{3}, {60, 240, 75});
        auto scales_node = op::v0::Constant::create(element::f32, Shape{3}, {0.6, 2.0, 0.5});
        auto axis_node = op::v0::Constant::create(element::i64, {3}, std::vector<int64_t>{1, 2, 3});
    ...
    }
    {
        ...
        auto sizes_node = op::v0::Constant::create(element::i64, Shape{3}, {60, 240, 75});
        auto scales_node = op::v0::Constant::create(element::f32, Shape{3}, {0.6, 2.0, 0.5});
        auto axis_node = op::v0::Constant::create(element::i64, {3}, std::vector<int64_t>{2, 3, 4});

        auto first_transpose_perm = op::v0::Constant::create(element::i64, Shape{5}, {0, 4, 1, 2, 3});
        auto last_transpose_perm = op::v0::Constant::create(element::i64, Shape{5}, {0, 2, 3, 4, 1});
...
TEST_F(TransformationTestsF, WrapInterpolateIntoTransposes4DScalesNotApplicable) {
    ...
    {
        auto input = std::make_shared<op::v0::Parameter>(element::f32, input_shape);
        auto sizes_node = op::v0::Constant::create(element::i64, Shape{2}, {50, 75});
        auto scales_node = op::v0::Constant::create(element::f32, Shape{2}, {0.5, 0.5});

        auto range_start = op::v0::Constant::create(element::i64, Shape{}, {0});
        auto range_stop = op::v0::Constant::create(element::i64, Shape{}, {4});
        auto range_step = op::v0::Constant::create(element::i64, Shape{}, {1});
        auto range = std::make_shared<op::v4::Range>(range_start, range_stop, range_step, element::i64);

        auto indices = op::v0::Constant::create(element::i64, {2}, std::vector<int64_t>{1, 3});
        auto gather_axis_node = op::v0::Constant::create(element::i64, {1}, std::vector<int64_t>{0});
        auto gather_node = std::make_shared<op::v8::Gather>(range, indices, gather_axis_node);

        auto interpolate = std::make_shared<op::v4::Interpolate>(input, sizes_node, scales_node, gather_node, attrs);
...
TEST_F(TransformationTestsF, WrapInterpolateIntoTransposes5DScalesNotApplicable) {
    ...
    {
        auto input = std::make_shared<op::v0::Parameter>(element::f32, input_shape);
        auto sizes_node = op::v0::Constant::create(element::i64, Shape{3}, {50, 75, 600});
        auto scales_node = op::v0::Constant::create(element::f32, Shape{3}, {0.5, 0.5, 0.75});

        auto range_start = op::v0::Constant::create(element::i64, Shape{}, {0});
        auto range_stop = op::v0::Constant::create(element::i64, Shape{}, {5});
        auto range_step = op::v0::Constant::create(element::i64, Shape{}, {1});
        auto range = std::make_shared<op::v4::Range>(range_start, range_stop, range_step, element::i64);

        auto indices = op::v0::Constant::create(element::i64, {3}, std::vector<int64_t>{1, 3, 4});
        auto gather_axis_node = op::v0::Constant::create(element::i64, {1}, std::vector<int64_t>{0});
        auto gather_node = std::make_shared<op::v8::Gather>(range, indices, gather_axis_node);
