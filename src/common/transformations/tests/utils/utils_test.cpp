...
bool has_constant_value<bool>(const std::shared_ptr<Node>& node, const bool value, bool epsilon) {
    ...
    auto constant = ov::as_type_ptr<op::v0::Constant>(node);
    if (!constant) {
        return false;
    }
...
TEST(TransformationTests, HasConstantValueHelper) {
    auto float32_scalar = op::v0::Constant::create(element::f32, Shape{}, {1.234f});
    ...
    auto float32_1D = op::v0::Constant::create(element::f32, Shape{1}, {1.234f});
    ASSERT_TRUE(ov::op::util::has_constant_value<float>(float32_scalar, 1.234f));

    auto int64_scalar = op::v0::Constant::create(element::i64, Shape{}, {12});
    ASSERT_TRUE(ov::op::util::has_constant_value<int64_t>(int64_scalar, 12));

    auto bool_scalar = op::v0::Constant::create(element::boolean, Shape{}, {true});
    ...
    auto float32_2D = op::v0::Constant::create(element::f32, Shape{2}, {1.2f, 3.4f});
    ASSERT_FALSE(ov::op::util::has_constant_value<float>(float32_2D, 1.2f));

    float32_scalar = op::v0::Constant::create(element::f32, Shape{}, {1.234f});
    ASSERT_FALSE(ov::op::util::has_constant_value<float>(float32_scalar, 1.235f));

    float32_1D = op::v0::Constant::create(element::f32, Shape{1}, {1.234f});
    ASSERT_FALSE(ov::op::util::has_constant_value<float>(float32_scalar, 1.235f));

    int64_scalar = op::v0::Constant::create(element::i64, Shape{}, {12});
