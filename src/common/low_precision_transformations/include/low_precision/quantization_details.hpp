...
public:
    ...
    static bool outputLayoutIsSupported(std::shared_ptr<ov::op::v0::FakeQuantize> quantize, bool isConvertExpected = false);
    ...
    static QuantizationDetails getDetails(std::shared_ptr<ov::op::v0::FakeQuantize>);
