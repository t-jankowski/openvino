...
ConvolutionBackpropDataTransformation::ConvolutionBackpropDataTransformation(const Params& params) : WeightableLayerTransformation(params) {
    ...
    auto matcher = std::make_shared<pass::pattern::op::Or>(OutputVector{
        pattern::wrap_type<ov::op::v1::ConvolutionBackpropData>({
            pattern::wrap_type<ov::op::v1::Multiply>(),
            pattern::wrap_type<ov::op::v1::Multiply>()
        }),
        ov::pass::pattern::wrap_type<ov::op::v1::ConvolutionBackpropData>({
            pattern::wrap_type<ov::op::v1::Multiply>(),
...
bool ConvolutionBackpropDataTransformation::transform(ov::pass::pattern::Matcher &m) {
    ...
    if (!canBeTransformed(convolutionBackpropData)) {
        ...
        std::shared_ptr<ov::op::v1::Reshape> reshapeFromWeights = ov::as_type_ptr<ov::op::v1::Reshape>(weightsInput);
    ...
    std::shared_ptr<Node> newMultiplyAfter;
    {
        ...
        const auto relaxedConvolutionBackpropData = std::make_shared<ov::op::TypeRelaxed<ov::op::v1::ConvolutionBackpropData>>(
            *ov::as_type_ptr<ov::op::v1::ConvolutionBackpropData>(copyNode),
            std::vector<element::Type>{deqPrecision, deqPrecision},
            std::vector<element::Type>{deqPrecision});

        const auto newMultiplyAfterConst = foldConvert(
            std::make_shared<ov::op::v0::Constant>(dequantization.multiplyConstant->get_element_type(),
                                                   Shape{1},
        ...
        if (ov::is_type<ov::op::v0::Convert>(convolutionBackpropData->get_input_node_ptr(0))) {
...

    {
        ...
        auto subtractFromWeights = ov::as_type_ptr<ov::op::v1::Subtract>(multiplyFromWeights->get_input_node_shared_ptr(0));

        {
            ...
            const auto newMultiplyAfterConst = foldConvert(
                fold_reshape<ov::op::v1::Reshape>(
                    ...
                    std::make_shared<ov::op::v0::Constant>(element::u64, Shape{newScaleShape.size()}, newScaleShape),
                    false),
                deqPrecision);
            newMultiplyAfter = std::make_shared<ov::op::TypeRelaxed<ov::op::v1::Multiply>>(
                std::vector<element::Type>{deqPrecision, deqPrecision},
        ...
        std::shared_ptr<ov::op::v0::Convert> convertFromWeights =
                ov::as_type_ptr<ov::op::v0::Convert>(
                    subtractFromWeights == nullptr ?
