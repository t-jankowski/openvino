...
TEST_F(ExtractLoopInvariantsTest, ExtractedLoopInvariantsWithParams) {
    ...
    */
    {
        auto param00 = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape0);
        auto param01 = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape0);
        auto param1 = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape1);
        auto multiply = linear_ir->push_node<ov::op::v1::Multiply>(param00.second, param01.second);
        ...
        auto sub = linear_ir->push_node<ov::op::v1::Subtract>(param1.second, broadcastmove.second);
        init_expr_descriptors(*sub.first, sub_subtensor, layout_1d);
        auto result = linear_ir->push_node<ov::op::v0::Result>(sub.second);
    ...
    {
        auto param00 = linear_ir_ref->push_node<ov::op::v0::Parameter>(input_precision, input_shape0);
        auto param01 = linear_ir_ref->push_node<ov::op::v0::Parameter>(input_precision, input_shape0);
        auto param1 = linear_ir_ref->push_node<ov::op::v0::Parameter>(input_precision, input_shape1);
        auto multiply = linear_ir_ref->push_node<ov::op::v1::Multiply>(param00.second, param01.second);
        init_expr_descriptors(*multiply.first, mul_subtensor, layout_1d);
        auto broadcastmove = linear_ir_ref->push_node<ov::snippets::op::BroadcastMove>(multiply.second, 512);
        auto sub = linear_ir_ref->push_node<ov::op::v1::Subtract>(param1.second, broadcastmove.second);
        init_expr_descriptors(*sub.first, sub_subtensor, layout_1d);
        auto result = linear_ir_ref->push_node<ov::op::v0::Result>(sub.second);
...
TEST_F(ExtractLoopInvariantsTest, ExtractedLoopInvariantsWithScalar) {
    ...
    */
    {
        auto param0 = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape0);
        auto param1 = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape1);
        auto scalar = linear_ir->push_node<ov::snippets::op::Scalar>(input_precision, scalar_shape, 3.8f);
        auto multiply = linear_ir->push_node<ov::op::v1::Multiply>(param0.second, scalar.second);
        init_expr_descriptors(*multiply.first, mul_subtensor, layout_1d);
        auto broadcastmove = linear_ir->push_node<ov::snippets::op::BroadcastMove>(multiply.second, 512);
        auto sub = linear_ir->push_node<ov::op::v1::Subtract>(param1.second, broadcastmove.second);
        init_expr_descriptors(*sub.first, sub_subtensor, layout_1d);
    ...
    {
        auto param0 = linear_ir_ref->push_node<ov::op::v0::Parameter>(input_precision, input_shape0);
        auto param1 = linear_ir_ref->push_node<ov::op::v0::Parameter>(input_precision, input_shape1);
        auto scalar = linear_ir_ref->push_node<ov::snippets::op::Scalar>(input_precision, scalar_shape, 3.8f);
        auto multiply = linear_ir_ref->push_node<ov::op::v1::Multiply>(param0.second, scalar.second);
        init_expr_descriptors(*multiply.first, mul_subtensor, layout_1d);
        auto broadcastmove = linear_ir_ref->push_node<ov::snippets::op::BroadcastMove>(multiply.second, 512);
        auto sub = linear_ir_ref->push_node<ov::op::v1::Subtract>(param1.second, broadcastmove.second);
        init_expr_descriptors(*sub.first, sub_subtensor, layout_1d);
...
TEST_F(ExtractLoopInvariantsTest, ExtractedLoopInvariantsOutputLoopUpdateNotNeed) {
    ...
    */
    {
        auto param0 = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape_a);
        auto param1 = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape_a);
        auto param2 = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape_b);
        auto param3 = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape_b);
        auto multiply = linear_ir->push_node<ov::op::v1::Multiply>(param0.second, param1.second);
        ...
        auto add = linear_ir->push_node<ov::op::v1::Add>(param2.second, broadcastmove.second);
        init_expr_descriptors(*add.first, subtensor_add, layout);
        auto sub = linear_ir->push_node<ov::op::v1::Subtract>(param3.second, add.second);
        auto result0 = linear_ir->push_node<ov::op::v0::Result>(add.second);
        auto result1 = linear_ir->push_node<ov::op::v0::Result>(sub.second);
        auto begin = multiply.first;
    ...
    {
        auto param0 = linear_ir_ref->push_node<ov::op::v0::Parameter>(input_precision, input_shape_a);
        auto param1 = linear_ir_ref->push_node<ov::op::v0::Parameter>(input_precision, input_shape_a);
        auto param2 = linear_ir_ref->push_node<ov::op::v0::Parameter>(input_precision, input_shape_b);
        auto param3 = linear_ir_ref->push_node<ov::op::v0::Parameter>(input_precision, input_shape_b);
        auto multiply = linear_ir_ref->push_node<ov::op::v1::Multiply>(param0.second, param1.second);
        init_expr_descriptors(*multiply.first, subtensor_mul, layout);
        auto broadcastmove = linear_ir_ref->push_node<ov::snippets::op::BroadcastMove>(multiply.second, 16);
        auto add = linear_ir_ref->push_node<ov::op::v1::Add>(param2.second, broadcastmove.second);
        init_expr_descriptors(*add.first, subtensor_add, layout);
        auto sub = linear_ir_ref->push_node<ov::op::v1::Subtract>(param3.second, add.second);
        auto result0 = linear_ir_ref->push_node<ov::op::v0::Result>(add.second);
        auto result1 = linear_ir_ref->push_node<ov::op::v0::Result>(sub.second);
...
TEST_F(ExtractLoopInvariantsTest, ExtractedLoopInvariantsFromInnermostToLoopOutside) {
    ...
    */
    {
        auto param_0 = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape_0);
        auto param_1 = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape_1);
        ...
        auto add = linear_ir->push_node<ov::op::v1::Add>(param_0.second, broadcastmove.second);
    ...
    {
        auto param_0 = linear_ir_ref->push_node<ov::op::v0::Parameter>(input_precision, input_shape_0);
        auto param_1 = linear_ir_ref->push_node<ov::op::v0::Parameter>(input_precision, input_shape_1);
        auto broadcastmove = linear_ir_ref->push_node<ov::snippets::op::BroadcastMove>(param_1.second, 512);
        init_expr_descriptors(*broadcastmove.first, {{1, 1}, subtensor}, {layout, layout});
        auto add = linear_ir_ref->push_node<ov::op::v1::Add>(param_0.second, broadcastmove.second);
        init_expr_descriptors(*add.first, {subtensor, subtensor, subtensor}, {layout, layout, layout});
...
TEST_F(ExtractLoopInvariantsTest, ExtractedLoopInvariantsImpossible) {
    ...
    */
    {
        auto param = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape_0);
...
TEST_F(ExtractLoopInvariantsTest, ExtractedLoopInvariantsSplitLoops) {
    ...
    */
    {
        const auto param0 = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape_0);
        const auto param1 = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape_1);
        const auto param2 = linear_ir->push_node<ov::op::v0::Parameter>(input_precision, input_shape_2);
        ...
        init_expr_descriptors(*broadcastmove.first, {{1, 1}, subtensor}, {layout, layout});
        const auto add = linear_ir->push_node<ov::op::v1::Add>(matmul.second, broadcastmove.second);
        init_expr_descriptors(*add.first, {subtensor, subtensor, subtensor}, {layout, layout, layout});
    ...
    {
        const auto param0 = linear_ir_ref->push_node<ov::op::v0::Parameter>(input_precision, input_shape_0);
        const auto param1 = linear_ir_ref->push_node<ov::op::v0::Parameter>(input_precision, input_shape_1);
        const auto param2 = linear_ir_ref->push_node<ov::op::v0::Parameter>(input_precision, input_shape_2);
        ...
        const auto add = linear_ir_ref->push_node<ov::op::v1::Add>(matmul.second, broadcastmove.second);
        init_expr_descriptors(*add.first, {subtensor, subtensor, subtensor}, {layout, layout, layout});
        auto result = linear_ir_ref->push_node<ov::op::v0::Result>(add.second);
    ...
    */
    {
        ...
        auto max = linear_ir->push_node<ov::op::v1::Maximum>(param.second, vector_max.second);
        ...
        auto sub = linear_ir->push_node<ov::op::v1::Subtract>(param.second, hmax.second);
        init_expr_descriptors(*sub.first, {subtensor, subtensor, subtensor}, {layout, layout, layout});
        auto exp = linear_ir->push_node<ov::op::v0::Exp>(sub.second);
        init_expr_descriptors(*exp.first, {subtensor, subtensor}, {layout, layout});
        auto add = linear_ir->push_node<ov::op::v1::Add>(exp.second, vector_sum.second);
        ...
        auto multiply = linear_ir->push_node<ov::op::v1::Multiply>(exp.second, power_static.second);
        init_expr_descriptors(*multiply.first, {subtensor, subtensor, subtensor}, {layout, layout, layout});
        auto result = linear_ir->push_node<ov::op::v0::Result>(multiply.second);
        // 3 inner loop
    ...
    }
    {
        ...
        auto max = linear_ir_ref->push_node<ov::op::v1::Maximum>(param.second, vector_max.second);
        init_expr_descriptors(*max.first, {{subtensor}, {1}, {subtensor}}, {layout, {0}, layout});
        auto hmax = linear_ir_ref->push_node<ov::snippets::op::HorizonMax>(max.second);
        auto sub = linear_ir_ref->push_node<ov::op::v1::Subtract>(param.second, hmax.second);
        init_expr_descriptors(*sub.first, {subtensor, subtensor, subtensor}, {layout, layout, layout});
        auto exp = linear_ir_ref->push_node<ov::op::v0::Exp>(sub.second);
        init_expr_descriptors(*exp.first, {subtensor, subtensor}, {layout, layout});
        auto add = linear_ir_ref->push_node<ov::op::v1::Add>(exp.second, vector_sum.second);
        init_expr_descriptors(*add.first, {subtensor, {1}, subtensor}, {layout, {0}, layout});
        ...
        init_expr_descriptors(*power_static.first, {subtensor, subtensor}, {layout, layout});
        auto multiply = linear_ir_ref->push_node<ov::op::v1::Multiply>(exp.second, power_static.second);
        init_expr_descriptors(*multiply.first, {subtensor, subtensor, subtensor}, {layout, layout, layout});
        auto result = linear_ir_ref->push_node<ov::op::v0::Result>(multiply.second);
        // outer loop
        const auto loop_begin = std::make_shared<ov::snippets::op::LoopBegin>();
